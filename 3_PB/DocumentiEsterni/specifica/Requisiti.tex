...
\hline
R-57-F-Ob & L'utente deve poter inserire il valore per il filtro "Tempo di conservazione" & Soddisfatto \\
\hline
...
\hline
R-65-F-Ob & Il sistema deve rendere disponibile una sezione per il filtro comune "Soggetto" & Soddisfatto \\
\hline
...
\hline
R-167-F-Ob & All'interno della sezione di filtri per custom metadata, il sistema deve permettere di selezionare i filtri specifici per i metadata presenti & Soddisfatto \\
\hline
