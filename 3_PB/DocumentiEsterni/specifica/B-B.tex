...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{%
  \begin{tabularx}{\textwidth}{|>{\hsize=1.35\hsize\raggedright\arraybackslash}X|>{\hsize=0.95\hsize\raggedright\arraybackslash}X|>{\hsize=0.85\hsize\raggedright\arraybackslash}X|>{\hsize=1.35\hsize\raggedright\arraybackslash}X|}
    \hline
