...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../../assets/outDiagrammiST/C4_Integrity_Backend.png}
\caption{C4 del modulo Verifica Integrita}
\label{fig:integrity:c4-backend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../../assets/outDiagrammiST/C4_Integrity_Verification_Sequence.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../../assets/outDiagrammiST/C4_Integrity_Aggregation_State.png}
