...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|Y|}
		...
		\hline
		Persistence & \texttt{IUpdate*IntegrityStatusPort.ts}, \texttt{*PersistenceAdapter}\\
		\hline
...
La vista focalizzata sul percorso di verifica integrita e mostrata in Figura~\ref{fig:integrity:c3-focused}.
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{../../assets/outDiagrammiST/C4_Integrity_Domain.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{../../assets/outDiagrammiST/C4_Integrity_Backend.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{../../assets/outDiagrammiST/C4_Integrity_Verification_Sequence.png}
