...
\href{https://7-zpus.github.io/Docs/assets/3_PB/DocumentiInterni/Glossario.pdf}{Glossario 2.0}\ped{(v2.0.0)}.
...
\subsection{Riferimenti}
    ...
    \begin{itemize}
        ...
        \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Dispense/PD1.pdf}{\ul{Regolamento di Progetto Didattico a.a.
            2025/2026}\setulcolor{black}} \ped{(ultimo accesso: 02/03/2026)}
    \end{itemize}
...
\subsection{[Container 3]}
    ...
    \subsubsection{Configurazione}
        \paragraph{Schema dei dati}
        \paragraph{Definizione}

\subsection{Riepilogo tracciamento dei requisiti}

\newpage
\section{Progettazione di dettaglio dei container}

\subsection{[Componente 1]}
    \subsubsection{Diagramma delle componenti}
    \subsubsection{Lista delle sottocomponenti}
        \paragraph{[Sottocomponente 1.1]}
        \paragraph{[Sottocomponente 1.2]}
        \paragraph{[Sottocomponente 1.n]}

\subsection{[Componente 2]}
    \subsubsection{Diagramma delle componenti}
    \subsubsection{Lista delle sottocomponenti}
        \paragraph{[Sottocomponente 2.1]}
        \paragraph{[Sottocomponente 2.2]}
        \paragraph{[Sottocomponente 2.n]}

\newpage
\section{Progettazione di dettaglio delle componenti}
