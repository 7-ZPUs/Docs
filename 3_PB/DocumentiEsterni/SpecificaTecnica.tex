...
\newcommand{\codeword}[1]{{\textcolor{codewordcolor}{\textit{#1}}}}
...
\input{specifica/Abstract.tex}
\input{specifica/Container.tex}
\input{specifica/F-VI.tex} % Verifica Integrità
\input{specifica/F-S.tex}  % Search 
\input{specifica/F-DD.tex} % Document Details
\input{specifica/F-N.tex}  % Navigazione 
\input{specifica/B-I.tex}  % Indexing 
\input{specifica/B-B.tex}  % Browsing 
\input{specifica/B-S.tex}
\input{specifica/B-E.tex}
\input{specifica/B-VI.tex} % Verifica Integrità
\input{specifica/Requisiti.tex}
\end{document}
