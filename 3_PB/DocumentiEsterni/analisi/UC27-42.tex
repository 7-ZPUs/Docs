...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC53INC.png}
...
\usecase{visualizzaTipoAggregazione}{Visualizza tipo di aggregazione documentale}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \label{fig:inclusioniVisualizzaFasiProcedimentoAmministrativo}
\end{figure}
...
\begin{itemize}
    ...
    \end{enumerate}
    \item \textbf{Postcondizioni}: L'utente visualizza la lista dei metadati custom del documento selezionato
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video la lista di metadati custom per il documento selezionato
        \end{enumerate}
    \item \textbf{Flusso Alternativo}:
    \begin{itemize}
        \item Il documento selezionato non dispone di metadati custom (\ref{metadatiCustomAssenti})
    \end{itemize}
    \item \textbf{Inclusioni}: \ref{visualizzaMetadatoInLista} Visualizza elemento lista metadati custom
    \item \textbf{Estensioni}: \ref{metadatiCustomAssenti} Metadati custom assenti
\end{itemize}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../../assets/uml/UC71INC.png}
...
\subusecase{visualizzaMetadatoInLista}{Visualizza elemento lista metadati custom}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
        \item L'utente ha avviato l'applicazione
        \item L'utente sta visualizzando la lista dei metadati custom del documento selezionato
    \end{enumerate}
    \item \textbf{Postcondizioni}: L'utente visualizza il nome e il valore del metadato custom come stringa
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video il nome del metadato custom (\ref{visualizzaNomeMetadatoCustom})
            \item Il sistema mostra a video il valore del metadato custom come stringa (\ref{visualizzaValoreMetadatoCustom})
        \end{enumerate}
...
\subsubusecase{visualizzaValoreMetadatoCustom}{Visualizza valore metadato custom}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
        \item \textbf{Precondizioni}:
        \begin{enumerate}
