...
\section*{Tabella di Versionamento}
    ...
    \begin{longtable}{|c|c|c|c|c|}
        ...
        \hline
        2.0.0 & 2026/04/13 & Rocco Matteo A. & Gingillino Aaron & \begin{tabular}[c]{@{}c@{}} Approvazione per \\ Product Baseline \end{tabular} \\
        \hline
        1.2.0 & 2026/03/02 & Rocco Matteo A. & Fattoni Antonio & \begin{tabular}[c]{@{}c@{}}Correzione requisiti \\non funzionali \\e aggiornamento \\tracciamento\end{tabular} \\
        \hline
        1.1.0 & 2026/02/28 & Vigolo Davide & Fattoni Antonio & \begin{tabular}[c]{@{}c@{}}Correzione UC \\ compilazione e\\ validazione campi\end{tabular} \\
        \hline
        1.0.1 & 2026/02/28 & Fattoni Antonio & Vigolo Davide & \begin{tabular}[c]{@{}c@{}}Correzione UC \\ visualizzazione liste\end{tabular} \\
        \hline
        1.0.0 & 2026/02/13 & Laoud Zakaria & Fattoni Antonio & \begin{tabular}[c]{@{}c@{}} Approvazione per \\ baseline RTB \end{tabular} \\
        \hline
        ...
        \hline
        0.2.0 & 2025/12/12 & Soligo Lorenzo & Rocco Matteo A. & \begin{tabular}[c]{@{}c@{}} Modularizzazione\\ file Tex \end{tabular} \\
        \hline
        0.1.0 & 2025/11/07 & Georgescu Diana & Laoud Zakaria & \begin{tabular}[c]{@{}c@{}} Creazione del template\\ e stesura iniziale \end{tabular} \\
        \hline
    \end{longtable}
    \end{center}
...
L'elaborazione dei requisiti trae origine dallo studio preliminare del capitolato, al fine di individuare gli \glossario{attori} coinvolti e le funzionalità attese.\\
...
Per una corretta comprensione del documento, si rimanda al documento di \href{https://7-zpus.github.io/Docs/assets/2_RTB/DocumentiInterni/Glossario.pdf}{\ul{Glossario}\setulcolor{black}}\ped{(v1.0.0)} contenente la definizione dei termini contrassegnati dalla \textit{G} a pedice (\glossario{Glossario}).
...
\begin{itemize}
    \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C3.pdf}{\ul{Capitolato C3: DIPReader}\setulcolor{black}} \ped{(ultimo accesso: 18/02/2025)}
    \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Dispense/PD1.pdf}{\ul{Regolamento di Progetto Didattico a.a. 2025/2026}\setulcolor{black}} \ped{(ultimo accesso: 17/01/2025)}
    \item \href{https://7-zpus.github.io/Docs/assets/2_RTB/DocumentiInterni/NormeDiProgetto.pdf}{\ul{Norme di Progetto}\setulcolor{black}}\ped{(v1.0.0)}
\end{itemize}

\subsubsection{Riferimenti Informativi}
\begin{itemize}
    \item \href{https://7-zpus.github.io/Docs/assets/2_RTB/DocumentiInterni/Glossario.pdf}{\ul{Glossario di progetto}\setulcolor{black}}\ped{(v1.0.0)}
    ...
    \begin{itemize}
        ...
        \item \href{https://www.math.unipd.it/~rcardin/swea/2022/Diagrammi%20Use%20Case.pdf}{\ul{https://www.math.unipd.it/~rcardin/swea/2022/Diagrammi\%20Use\%20Case.pdf}\setulcolor{black}} \ped{(ultimo accesso: 24/12/2025)}
...
Il software oggetto di sviluppo è \textbf{DIPReader}, un'applicazione per l'accesso e la visualizzazione di \glossario{documenti} informatici all'interno di un Dissemination Information Package (\glossario{DIP}), ovvero un archivio compresso distribuito da un sistema di conservazione centralizzato. \\

\noindent Un DIP contiene un insieme di cartelle e documenti tecnici con valore legale, strutturati secondo specifiche normative che ne garantiscono autenticità, integrità e ottimizzazione dello spazio di archiviazione.
...
DIPReader nasce per affrontare questa difficoltà, fornendo una soluzione dedicata che consenta di esplorare, ricercare e consultare in modo efficiente e intuitivo i contenuti dei pacchetti DIP, supportando al contempo le esigenze operative e normative del contesto in cui vengono utilizzati.
...
\begin{itemize}
    ...
    \item Possibilità di ricercare i documenti per attributi significativi (\glossario{metadati}).
    \item Possibilità di salvare uno o più documenti nel computer dell'utente.
    \item Possibilità di verificare l'integrità di un file.
    \item Possibilità di visualizzare le informazioni riguardanti il \glossario{processo di conservazione}.
    \item Mantenere la portabilità senza necessitare installazioni su disco.
    \item Possibilità di stampare i documenti selezionati.
    \item \glossario{Ricerca semantica} dei documenti mediante algoritmi di intelligenza artificiale.
    \item Possibilità di visualizzare lo stato dell'eventuale \glossario{firma digitale} associata al file.
\end{itemize}
