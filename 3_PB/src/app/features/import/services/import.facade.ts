...
import { ErrorCode, ErrorCategory } from '../../../shared/domain/app-error';
...
export class ImportFacade implements IDipFacade {
  ...
  // UC-35: scarica dal Main | UC-36: gestisce errore
  // ------------------------------------------------------------------
  ...
  async loadChildren(nodeId: string): Promise<void> {
    // Controlla se i figli sono già in nodeCache dello state
