...
Il fornitore deve pianificare il lavoro a lungo termine. Deve definire milestone e obiettivi intermedi.
...
tramite il cruscotto fornito da Jira, controlla quali attività sono state
completate, quali sono in corso e quali sono in ritardo. Se necessario,
rialloca le risorse liberate da task completate.
...
I CIs sono sempre associati a un Epic di Jira. In questo modo si garantiscono tracciabilità e gestione delle modifiche. In particolare, il processo di creazione deve seguire i seguenti passaggi:
\begin{enumerate}
...
Il processo di garanzia della qualità applica in modo sistematico le metriche definite. Coordina anche garanzia della qualità, verifica, validazione e miglioramento. L'obiettivo è mantenere alta la qualità del prodotto finale e dei processi. \\Questo processo segue tutte le fasi del ciclo di vita del progetto.
...
\metricdef{MPD-1}{Requisiti obbligatori soddisfatti}
...
\metricdef{MPD-2}{Requisiti opzionali soddisfatti}
...
\metricdef{MPD-3}{Requisiti desiderabili soddisfatti}
...
{Tempo di \glossario{indicizzazione} per un DiP di dimensioni standard (1-4GB).}
\metricformula{IT = \text{Tempo di indicizzazione (secondi)}}

\metricdef{MPD-9}{Search Time}
{Tempo medio di risposta per un set di query predefinite.}
