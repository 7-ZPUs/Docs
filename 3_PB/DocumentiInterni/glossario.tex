...
\begin{itemize}
    ...
    \item \textbf{Adapter}: un oggetto che si occupa di trasformare il tipo di un dato in un altro 
...
\section{C}
\begin{itemize}
    \item \textbf{C4}: il modello C4 permette di progettare applicazioni affrontando 4 livelli di astrazionie diversi. 
...
\begin{itemize}
    ...
    \item \textbf{Deployment}: processo di pubblicazione dell'applicazione.
...
\begin{itemize}
    ...
    \item \textbf{Filesystem}: struttura dati che si occupa della gestione e all'archiviazione dei file su un computer.
...
\begin{itemize}
    ...
    \item \textbf{Lazy loading}: tecnica che prevede il caricamento di ciò che è necessario solo nel momento in cui viene richiesto.
...
\begin{itemize}
    ...
    \item \textbf{Pipeline}: insieme di passaggi organizzati.
...
\begin{itemize}
    ...
    \item \textbf{Token di iniezione}: è una chiave utilizzata da Angular per capire quale dipendenza fornire.  
