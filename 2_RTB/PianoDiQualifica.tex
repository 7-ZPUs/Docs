...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \textbf{Valore accettabile} & \textbf{Valore desiderabile} \\
        \hline
        MPC-1 & AC (Actual Cost) & & \\
        \hline
        MPC-2 & EA (Earned Value) & & \\
        \hline
        MPC-3 & PV (Planned Value) & & \\
        \hline
        MPC-4 & EAC (Estimate at Completion) & & \\
        \hline
        MPC-5 & ETC (Estimate to Complete) & & \\
        \hline
        MPC-6 & CPI (Cost Performance Index) & & \\
        \hline
        MPC-7 & BV (Budget Variance) & & \\
        \hline
        MPC-8 & SV (Schedule Variance) & & \\
        \hline
