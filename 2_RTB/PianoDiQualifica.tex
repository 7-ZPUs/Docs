...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPC-11 & Work in progress & & \\
        \hline
        MPC-12 & Deployment frequency & & \\
        \hline
        MPC-13 & Change failure rate & & \\
        \hline
    \end{tabular}
    \end{spacing}
    \end{adjustwidth}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPC-18 & Code review turnaround time & & \\
        \hline
        MPC-19 & Statement coverage & & \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPC-21 & Rischi non previsti & & \\
        \hline
        MPC-22 & Efficacia contromisure rischi & & \\
        \hline
        MPC-23 & Densità degli errori & & \\
        \hline
    \end{tabular}
    \end{spacing}
    \end{adjustwidth}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPD-1 & Stabilità dei requisiti & & \\
        \hline
        MPD-2 & Metriche soddisfatte & & \\
        \hline
        MPD-3 & Requisiti obbligatori soddisfatti & & \\
        \hline
        MPD-4 & Requisiti opzionali soddisfatti & & \\
        \hline
        MPD-5 & Requisiti desiderabili soddisfatti & & \\
        \hline
    \end{tabular}
    \end{spacing}
    \end{adjustwidth}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPD-7 & Indice di Gulpease & & \\
        \hline
        MPD-8 & Livello conformità WCAG & & \\
        \hline
        MPD-9 & Profondità di navigazione & & \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPD-11 & Tempo di risposta (Time To First Byte) & 1.5 s & 0.5 s \\
        \hline
        MPD-12 & Document Retrieval Time (DRT) & & \\
        \hline
        MPD-13 & Tempo rendering prima pagina & & \\
        \hline
        MPD-14 & Average CPU usage & & \\
        \hline
        MPD-15 & Peak memory usage & & \\
        \hline
    \end{tabular}
    \end{spacing}
    \end{adjustwidth}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
       ...
       \hline
        ...
        \hline
        MPD-18 & Accoppiamento tra classi & & \\
        \hline
    \end{tabular}
    \end{spacing}
    \end{adjustwidth}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \textbf{Codice} & \textbf{Nome metrica} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{accettabile} \end{tabular} & \begin{tabular}[c]{@{}c@{}}  \textbf{Valore}\\\textbf{desiderabile} \end{tabular} \\
        \hline
        MPD-19 & Browser supportati & & \\
        \hline
        MPD-20 & Sistemi operativi supportati & & \\
        \hline
    \end{tabular}
    \end{spacing}
    \end{adjustwidth}
...
\hline
TS-91 & Verificare che per l'Aggregazione Documentale Informatica, l'utente possa inserire il valore per il filtro "Identificativo dell'Aggreagazione Documentale" & R-91-F-Ob & NO \\
\hline
...
TS-108 & Verificare che l'utente possa compilare il filtro selezionato con un valore & R-108-F-Ob & NI  \\
\hline
