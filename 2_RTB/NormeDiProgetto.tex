...
\begin{table}[H]
    \begin{adjustwidth}{-4cm}{-4cm}
        ...
        \begin{tabular}{|c|c|c|c|c|}
            ...
            0.8 & 11/1/2026 & Soligo Lorenzo &  & Stesura paragrafi 4.2, 4.3, 4.4 \\
            \hline
...
\subsubsection{Attività: Implementazione}
...
\subsubsection{Attività: Creazione}
...
Strumento per l'hosting utilizzato per il testing delle nuove tecncologie. 
...
\subsubsection{Strumenti dell'Infrastruttura}
\paragraph{GitHub} \label{GitHub}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Verbali \begin{itemize}
            ...
            \item Esterni
            \end{itemize}
    \item \textbf{.analisi}: Directory contenente i file di Analisi dei Requisiti del progetto.
