...
\subsection{Processo di garanzia della qualità} \label{garanzia_qualita}
\subsection{Processo di verifica} \label{processo_verifica}
\subsection{Processo di validazione} \label{prosso_validazione}
...
\section{Knowledge Base} \label{knowladge_base}
