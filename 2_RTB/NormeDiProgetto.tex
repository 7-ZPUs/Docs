...
% \paragraph{Strumenti di Pianificazione operativa}
% \begin{itemize}
...
% \paragraph{Strumenti di Gestione dei rischi operativi}
% \begin{itemize}
...
% del progetto. Ogni richiesta nasce come \glossario{issue} DIPR tracciata su \glossario{Jira}, collegata allo \glossario{CIs} coinvolto tramite gli Smart Commit descritti
...
% \paragraph{Strumenti di Manutenzione correttiva}
% \begin{itemize}
...
% \paragraph{Strumenti di Manutenzione adattiva}
% \begin{itemize}
...
% \paragraph{Strumenti di Manutenzione preventiva}
% \begin{itemize}
...
% \paragraph{Strumenti di Identificazione della necessità di manutenzione}
% \begin{itemize}
%     \item Dashboard Jira.
...
% \paragraph{Strumenti di Verifica e validazione delle modifiche}
% \begin{itemize}
%     \item GitHub Actions.
...
% \paragraph{Strumenti di Monitoraggio delle metriche}
% \begin{itemize}
...
Il controllo della configurazione è il processo con il quale vengono gestite le richieste di modifica ai CIs. 
...
garantendo tracciabilità e controllo delle modifiche. Come gestire branch e work item viene descritto nella sezione \ref{gestione_processi_organizzativi}\\ \\
...
\begin{itemize}
    \item \textbf{Approvazione}: Il revisore procede con l'approvazione delle modifiche e la chiusura della PR tramite l'opzione "Create Merge Commit".
    \begin{figure}[H]
    \label{PR2}
    \centering
