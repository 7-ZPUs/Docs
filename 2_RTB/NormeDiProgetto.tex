...
\glossario{\textit{Agile}} e \glossario{iterativi} che caratterizzano lo
...
Il processo di fornitura contiene le attività e i compiti svolti
dal fornitore, ovvero la \glossario{proponente}. Per implementare correttamente il processo il gruppo
...
l’architettura organizzativa entro il quale il prodotto verrà sviluppato e gestito, in
...
Il documento di \href{https://cdn.jsdelivr.net/gh/7-zpus/Docs@main/1_Candidatura/LetteraDiPresentazione.pdf}{\ul{Lettera di presentazione}\setulcolor{black}} \ped{(ultimo accesso: )} formalizza la candidatura del team ai committenti per lo sviluppo del progetto proposto, dichiarando la data di consegna, il budget stimato e la composizione ufficiale del team.
...
\begin{itemize}
    \item Jira per la gestione delle attività di progetto. In particolare con la \glossario{board} \glossario{Scrum} che viene aggiornata in automatico con i commit effettuati sui Work Item e può essere personalizzata con la creazione di \glossario{Sprint}.
