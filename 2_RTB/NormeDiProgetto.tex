...
\subsubsection{Attività:Accordi con l'azienda proponente}
...
hanno accordato lo svolgimento di un incontro di verifica dello \glossario{stato di
avanzamento lavori (SAL)} in modalità sincrona ogni due settimane,
...
\glossario{milestone} principali: \glossario{Requirements and Tecnology Baseline (RTB)} e \glossario{Product Baseline (PB)}.
