...
\href{https://7-zpus.github.io/Docs/assets/pdf/AnalisiCapitolati.pdf}{\ul{Analisi
        dei capitolati}\setulcolor{black}}
...
Nel caso di documenti si racchiudono gruppi di documenti omogenei con un unico CI.
...
\begin{itemize}
    \item La creazione del branch deve avvenire preferibilmente in modo automatico
          tramite l'integrazione Jira-VSCode (vedi §\ref{vscode}).
