...
UC sta per Use Case, ovvero caso d'uso in inglese. Gli UC sono identificati univocamente tramite un enumerazione crescente. \textit{Primario} è il numero dello UC principale. È possibile avere dei \textit{sotto-UC}, in tal caso verrà aggiunto il numero crescente del sotto-UC come pendice allo UC genitore. 
...
\begin{itemize}
    ...
    \item Verificatore: si occupa di verificare che il prodotto sia a regola d'arte, dunque aderisca alle norme di progetto. Si occupa di controllare la documentazione e il codice in cerca di possibili errori, che siano stilistici o di contenuto, e avvisare gli autori in questione del problema.
\end{itemize}
