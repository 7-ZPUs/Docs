...
\begin{itemize}
    \item Tutti i file dei documenti devono seguire la regola del \textbf{Camel Case}, ovvero
...
\end{itemize}
Per quanto riguarda ciò che riguarda la denominazione dei file sul sito, si seguono le stesse regole, aggiungendo però il numero di versione alla fine del nome del file. Per le regole di versionamento si rimanda a \ref{versione}.
...
Questa attività normativa il modo in cui le modifiche di avanzamento vengono registrate e
