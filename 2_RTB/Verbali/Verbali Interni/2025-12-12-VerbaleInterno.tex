...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 2025/12/14 & Laoud Zakaria & Rocco Matteo A. & \begin{tabular}[c]{@{}c@{}} Creazione del verbale\\ e stesura iniziale \end{tabular} \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
\subsection{Incontro con Professor Cardin}
Durante l'incontro con il Professor Cardin sono state poste alcune domande riguardanti l'analisi dei requisiti. Di seguito sono riportate le risposte fornite: \\\\
...
Dopo l'incontro con il Professor Cardin, il gruppo ha deciso di procedere con l'aggiunta dei casi di errore come estensioni degli use case principali, suddividendo il documento
...
\begin{enumerate}[noitemsep]
    ...
    \item Si è deciso di continuare con la stesura del piano di qualifica.
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#0 & Redazione del verbale & \href{https://7zpus.atlassian.net/browse/DIPR-122}{DIPR-122} & Laoud Zakaria & Rocco Matteo A. \\
    \hline
    \#1 & Norme di progetto & \href{https://7zpus.atlassian.net/browse/DIPR-139}{DIPR-139} & Amministratori & Amministratori \\
    \hline
    \#2 & Diario di bordo &  & Rocco Matteo A. & Tutti \\
    \hline
    \#3 & \begin{tabular}[c]{@{}c@{}} Aggiornamento analisi \\dei requisiti \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-131}{DIPR-131} & Analisti & Analisti \\
    \hline
    \#4 & Piano di qualifica & \href{https://7zpus.atlassian.net/browse/DIPR-138}{DIPR-138} & Rocco Matteo A. & Vigolo Davide \\
    \hline
    \#5 & \begin{tabular}[c]{@{}c@{}} Studio nuove\\ tecnologie \end{tabular} &  & Tutti & Tutti \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
