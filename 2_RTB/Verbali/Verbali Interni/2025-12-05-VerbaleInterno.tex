...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 07/11/2025 & Zakaria Laoud & Matteo Rocco A. & Creazione del verbale e stesura iniziale \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
\begin{enumerate}[noitemsep]
    ...
    \item Si è deciso di segnare il tempo stimato per ogni attività dello sprint.
    ...
    \item Si è deciso di approfondire alcune alternative alla classica visualizzazione ad albero per la navigazione tra le cartelle nel mockup.
\end{enumerate}
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#3 & Stima tempo singole attività dello sprint &  & Analisti & Analisti \\
    \hline
    \#4 & Stesura preventivo e consuntivo sprint 2 & \href{https://7zpus.atlassian.net/browse/DIPR-130}{DIPR-130} & Davide Vigolo & Rocco Matteo A.\\
    \hline
    \#5 & Stesura preventivo sprint 3 & \href{https://7zpus.atlassian.net/browse/DIPR-129}{DIPR-129} & Rocco Matteo A. & Davide Vigolo\\
    \hline
    \#6 & \begin{tabular}[c]{@{}c@{}} Ricerca alternativa \\visualizzazione ad albero \end{tabular} &  & Analisti &  Analisti\\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
