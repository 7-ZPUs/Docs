...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 2025/12/11 & Zakaria Laoud & Matteo Rocco A. & \begin{tabular}[c]{@{}c@{}} Creazione del verbale\\ e stesura iniziale \end{tabular} \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
Tale mockup sarà inoltre presentato e discusso con la proponente nell'incontro del 2025/12/11 per raccogliere feedback e suggerimenti. 
...
A tale scopo il gruppo si è preposto di discuterne con la proponente all'incontro del 2025/12/11.
...
\begin{itemize}
    ...
    \item aggiornare le norme di progetto (dalla sezione "Processo di verifica" alla "Gestione della qualità" e la sezione "Metriche della qualità")
\end{itemize}
...
\begin{tabular}{|c|c|c|c|c|}
    \hline
    \textbf{Decisione} & \textbf{To Do} & \textbf{Jira Issue} & \textbf{ \begin{tabular}[c]{@{}c@{}}Membro\\ assegnato\end{tabular}} & \textbf{Verificatore} \\
    \hline
    ...
    \hline
    \#2 & \begin{tabular}[c]{@{}c@{}} Aggiornamento piano \\di progetto \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-126}{DIPR-126} & Rocco Matteo A. &  Responsabili\\
    \hline
    \#3 & \begin{tabular}[c]{@{}c@{}} Stesura preventivo\\ e consuntivo Sprint 2 \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-130}{DIPR-130} & Davide Vigolo & Rocco Matteo A.\\
    \hline
    \#4 & \begin{tabular}[c]{@{}c@{}} Stesura preventivo \\Sprint 3 \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-129}{DIPR-129} & Rocco Matteo A. & Davide Vigolo\\
    \hline
    \#5 & \begin{tabular}[c]{@{}c@{}} Inizio stesura piano \\di qualifica \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-138}{DIPR-138} & Rocco Matteo A. & Davide Vigolo\\
    \hline
    \#6 & \begin{tabular}[c]{@{}c@{}} Aggiornamento norme \\di progetto \end{tabular} &  & Amministratori & Amministratori\\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
