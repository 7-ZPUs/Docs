...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#6 & \begin{tabular}[c]{@{}c@{}} Stesura verbale \\esterno 27/11/2025 \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-111}{DIPR-111} & Soligo Lorenzo & Laoud Zakaria\\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
