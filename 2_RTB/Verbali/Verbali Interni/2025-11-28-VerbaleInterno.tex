...
I ruoli assegnati a ciascun membro per questo sprint sono i seguenti. All'interno di questo sprint \textbf{ognuno} svolgerà anche il ruolo di \textbf{verificatore}.
\begin{table}[H]
...
È stata svolta la retrospettiva relativa al primo sprint, 

\subsection{Suddivisione del lavoro}
È stata trattata la suddivisione del lavoro per questo sprint e discusso riguardo il ruolo da assegnare a ciascun membro in base al compito da svolgere.
...
\begin{itemize}[noitemsep]
    \item 2025/12/15 ci si presuppone di avere terminato gran parte degli use case l'analisi dei requisiti
    \item 2026/01/12 ci si presuppone di avere una prima versione del POC
\end{itemize}
