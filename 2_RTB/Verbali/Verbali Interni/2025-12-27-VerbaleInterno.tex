...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 27/12/2025 & Georgescu Diana & Soligo Lorenzo & Creazione del verbale e stesura iniziale \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
I ruoli assegnati a ciascun membro per questa sprint sono i seguenti. Ciascuno svolgerà anche il ruolo di verificatore.
\begin{table}[H]
    \begin{adjustwidth}{-1cm}{-1cm}
    \centering
\begin{tabular}{|c|c|}
...
\begin{enumerate}[noitemsep]
    ...
    \item Continuare la scrittura dei paragrafi 3.x degli Use Case.
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline 
    \#1 & Aggiornamento analisi dei requisiti & \href{https://7zpus.atlassian.net/browse/DIPR-131}{DIPR-131} & Analisti & Analisti \\
    \hline
    \#2 & Continuazione delle norme di progetto & \href{https://7zpus.atlassian.net/browse/DIPR-139}{DIPR-139} & Programmatori & Programmatori \\
    \hline 
    \#3 & \begin{tabular}[c]{@{}c@{}} Aggiunta lista di inclusioni \\ ed estensioni agli Use Case \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-176}{DIPR-176} & Georgescu Diana & Verificatori\\
    \hline
    ...
    & Verificatori \\
    \hline
    \#5  & \begin{tabular}[c]{@{}c@{}} Redazione dei paragrafi 3.x \\ degli Use Case \end{tabular} & \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-141}{DIPR-141} \\ \href{https://7zpus.atlassian.net/browse/DIPR-142}{DIPR-142} \end{tabular} & Analisti & Verificatori \\
    \hline
    \#6 & Studio individuale delle tecnologie & & Tutti & Tutti \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
