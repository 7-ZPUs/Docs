...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 07/11/2025 & Georgescu Diana & Soligo Lorenzo & Creazione del verbale e stesura iniziale \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
\begin{enumerate}[noitemsep]
    ...
    \item Continuare la scrittura dei paragrafi 3.x che era stata rimandata.
    \item Continuare lo sviluppo del PoC con finalità dimostrative.
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline 
  \#2 & Continuazione delle norme di progetto 
& \href{https://7zpus.atlassian.net/browse/DIPR-139}{DIPR-139} 
& Programmatori 
& Programmatori \\
\hline
\#3 & Redazione dei paragrafi 3.x degli Use Case 
& \begin{tabular}[c]{@{}c@{}}
    \href{https://7zpus.atlassian.net/browse/DIPR-141}{DIPR-141} \\
    \href{https://7zpus.atlassian.net/browse/DIPR-142}{DIPR-142}
  \end{tabular}
& Analisti & Verificatori \\
\hline
\#4 & Studio individuale delle tecnologie 
&  & Tutti & Tutti \\
\hline
\end{tabular}
    \end{adjustwidth}
