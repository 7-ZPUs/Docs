...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 2025/12/19 & Vigolo Davide & Fattoni Antonio & \begin{tabular}[c]{@{}c@{}} Creazione del verbale\\ e stesura iniziale \end{tabular} \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
Il gruppo ha preso coscienza dell'assenza di un momento di retrospettiva formale alla fine degli scorsi Sprint, che ha portato a una mancanza di consapevolezza su eventuali criticità. Dal prossimo Sprint perciò si dedicherà un momento specifico alla retrospettiva all'inizio di ogni riunione principale.
\begin{itemize}[noitemsep]
    ...
    \item La sessione congiunta di sviluppo degli Use Case si è rivelata particolarmente efficace per allineare le conoscenze sull'analisi degli UC.
    ...
    \item É stata rilevata un'incongruenza nello stile di scrittura tra i diversi documenti. Per cercare di uniformare tale stile e rendere la lettura di tali documenti più fruibile è stato scelto di implementare un controllo dell'indice Gulpease e il monitoraggio come metrica di qualità di tale indice.
\end{itemize}
...
\noindent I ruoli assegnati a ciascun membro per questo Sprint sono i seguenti:
\begin{table}[H]
...
\begin{enumerate}[noitemsep]
    ...
    \item Si pianifica un incontro per redigere la mail da inviare al prof. Vardanega per aggiornamenti sullo Stato di Avanzamento dei Lavori (SAL).
    \item Le attività sui paragrafi 3.x degli Use Case vengono rimandate allo Sprint 4 per mancata analisi delle dipendenze.
    \item Si stabilisce che lo Sprint in corso abbia una durata di tre settimane, in considerazione del calo di disponibilità previsto nel periodo festivo.
\end{enumerate}
