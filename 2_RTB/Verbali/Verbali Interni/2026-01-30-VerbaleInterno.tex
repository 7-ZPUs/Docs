...
Il gruppo ha discusso le difficoltà dello \glossario{sprint} 5. I problemi principali riguardano la stima del tempo e la sua registrazione. È emerso che serve una migliore pianificazione. Bisogna usare Jira in modo più rigoroso. Ogni task deve avere una stima del tempo. Va registrato il tempo realmente usato.\\
Il gruppo ha deciso di usare un foglio di calcolo condiviso. Questo aiuta a vedere subito il tempo usato e il budget. Il foglio ha tabelle che si aggiornano da sole. Mostra i costi per ogni sprint e per ogni membro. I costi sono divisi per ruolo.\\

La pianificazione iniziale delle attività non è stata efficace. Il carico di lavoro era troppo alto. Il tempo disponibile era poco. La sessione d'esami ha ridotto il tempo. Anche la consegna del progetto di Tecnologie Web ha creato problemi.\\
Il gruppo aveva previsto il rischio \href{https://cdn.jsdelivr.net/gh/7-zpus/Docs@main/2_RTB/PianoDiProgetto.pdf}{RO05}. Le azioni per ridurlo non sono bastate. Non tutte le attività sono state completate. Questo ha causato ritardi. Le dipendenze tra task non sono state rispettate. I ritardi si sono così amplificati.\\
...
\begin{enumerate}[noitemsep]
    ...
    \item Inviare una mail a Sanmarco Informatica. Chiedere di spostare l'incontro del 5 febbraio. Serve più tempo per avere materiale da mostrare. In particolare i risultati dei test sulla Ricerca Semantica.
    \item Completare il Piano di Qualifica.
    \item Aggiornare il Glossario. Vanno aggiunti i termini nuovi. Questi vengono dall'analisi dei requisiti e dallo studio del PoC.
