...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#1 & \begin{tabular}[c]{@{}c@{}}Invio mail di \\ posticipa a Sanmarco \end{tabular} & --- & Fattoni Antonio & --- \\
    \hline
    \#2 & \begin{tabular}[c]{@{}c@{}}Completamento sezione \\di cruscotto di qualità\\ e inserimento sezione\\ di test \end{tabular} & \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-215}{DIPR-215} \\ \href{https://7zpus.atlassian.net/browse/DIPR-224}{DIPR-224} \end{tabular}  & \begin{tabular}[c]{@{}c@{}} Davide Vigolo \\ Rocco Matteo A. \end{tabular}  & \begin{tabular}[c]{@{}c@{}} Soligo Lorenzo \\Gingillino Aaron \end{tabular} \\
    \hline
    \#3 & \begin{tabular}[c]{@{}c@{}} Studio delle tecnologie\\ per Ricerca Semantica  \end{tabular}&  \href{https://7zpus.atlassian.net/browse/DIPR-200}{DIPR-200} & Soligo Lorenzo & Fattoni Antonio \\
    \hline
    \#4 & \begin{tabular}[c]{@{}c@{}}Completamento Paragrafi \\ delle Norme di \\Progetto mancanti  \end{tabular}& \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-225}{DIPR-225} \\ \href{https://7zpus.atlassian.net/browse/DIPR-230}{DIPR-230} \\ \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} \end{tabular} & \begin{tabular}[c]{@{}c@{}} Vigolo Davide \\ Fattoni Antonio \\ Rocco Matteo A. \end{tabular} & \begin{tabular}[c]{@{}c@{}} Soligo Lorenzo \\ Vigolo Davide \\ ?? \end{tabular} \\
    \hline
    \#5 & \begin{tabular}[c]{@{}c@{}} Stesura lettera di \\ candidatura per RTB \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Laoud Zakaria & ?? \\
    \hline
    \#6 & \begin{tabular}[c]{@{}c@{}} Revisione generale\\ forma documentazione  \end{tabular}&  \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Rocco Matteo A. & ?? \\
    \hline
    \#7 & Aggiornamento Glossario & \href{https://7zpus.atlassian.net/browse/DIPR-227}{DIPR-227} & Georgescu Diana & ?? \\
    \hline
    \#8 & Aggiornamento sito web & \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Fattoni Antonio & Laoud Zakaria \\
    \hline
    \#9 & \begin{tabular}[c]{@{}c@{}} Consuntivo Sprint 5 \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Fattoni Antonio & ?? \\
    \hline
    \#10 & \begin{tabular}[c]{@{}c@{}} Preventivo e\\ consuntivo Sprint 6 \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Laoud Zakaria & ?? \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
