...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#0 & Redazione del verbale interno& \href{https://7zpus.atlassian.net/browse/DIPR-211}{DIPR-211} & Rocco Matteo A. & Vigolo Davide \\
    \hline
    \#1 & \begin{tabular}[c]{@{}c@{}}Invio mail di \\ posticipa a Sanmarco \end{tabular} & --- & Fattoni Antonio & --- \\
    \hline
    \#2 & \begin{tabular}[c]{@{}c@{}}Completamento sezione di\\ cruscotto di qualità\\ e inserimento sezione\\ di test \end{tabular} & \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} \\ \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} \end{tabular}  & \begin{tabular}[c]{@{}c@{}} Davide Vigolo \\ Rocco Matteo A. \end{tabular}  & Soligo Lorenzo \\
    \hline
    \#3 & \begin{tabular}[c]{@{}c@{}} Studio delle tecnologie\\ per Ricerca Semantica  \end{tabular}&  \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Soligo Lorenzo & ?? \\
    \hline
    \#4 & \begin{tabular}[c]{@{}c@{}}Completamento Paragrafi delle\\Norme di Progetto mancanti  \end{tabular}& \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} \\ \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} \\ \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} \end{tabular} & \begin{tabular}[c]{@{}c@{}} Vigolo Davide \\ Fattoni Antonio \\ Rocco Matteo A. \end{tabular} & \begin{tabular}[c]{@{}c@{}} ?? \\ ?? \\ ?? \end{tabular} \\
    \hline
    ...
    \hline
    \#7 & Aggiornamento Glossario & \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Georgescu Diana & ?? \\
    \hline
    \#8 & Aggiornamento sito web & \href{https://7zpus.atlassian.net/browse/DIPR-??}{DIPR-??} & Fattoni Antonio & ?? \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
