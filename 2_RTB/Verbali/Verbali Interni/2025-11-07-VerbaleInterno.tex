...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 07/11/2025 & Rocco Matteo A. & Soligo Lorenzo & \begin{tabular}[c]{@{}c@{}}Creazione del verbale\\ e stesura iniziale\end{tabular} \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#7 & \begin{tabular}[c]{@{}c@{}} Preparazione e validazione\\Diario di Bordo 10/11/2025 \end{tabular} & \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-51}{DIPR-51}\\\href{https://7zpus.atlassian.net/browse/DIPR-52}{DIPR-52} \end{tabular} & Gingillino Aaron & Georgescu Diana \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
