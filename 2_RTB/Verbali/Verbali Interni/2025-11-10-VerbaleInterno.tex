...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 10/11/2025 & Vigolo Davide & Verificatore & Creazione del verbale e stesura iniziale \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
Vengono decisi i nuovi task da ultimare fino a fine sprint (giovedì): verrà presa la struttura standard del documento (output della task completata) e ognuno contribuirà in un brainstorming asincrono per cercare di riempire con le informazioni colte fino ad ora il documento di analisi dei requisiti. \\ 
