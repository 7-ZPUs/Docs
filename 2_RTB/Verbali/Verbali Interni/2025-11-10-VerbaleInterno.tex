...
\begin{enumerate}[noitemsep]
    \item Discussione incontro con la proponente di giovedì 2025/11/13
...
Per l'incontro con la proponente di giovedì 2025/11/13, viene deciso di preparare un documento che descriva in linea generale i requisiti che il gruppo ha ritenuto opportuni. I requisiti 
...
Vengono decisi i nuovi task da ultimare fino a fine Sprint (giovedì 2025/11/13): verrà presa la struttura standard del documento (output della task completata) e ognuno contribuirà in un brainstorming asincrono per cercare di riempire con le informazioni colte fino ad ora il documento di analisi dei requisiti. \\ 
