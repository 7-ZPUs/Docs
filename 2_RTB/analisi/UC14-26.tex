...
\begin{figure}[H]
    ...
    \caption{Diagramma delle inclusioni dell'UC-51}
    \label{fig:IncUC51}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagramma della generalizzazione dell'UC-51.1}
    \label{fig:GenUC51.1}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma delle inclusioni dell'UC-51.1}
    \label{fig:IncUC51.1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-51.1.1 e delle sue inclusioni}
    \label{fig:IncUC51.1.1}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-51.1.2 e delle sue inclusioni}
    \label{fig:IncUC51.1.2}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-51.1.3 e delle sue inclusioni}
    \label{fig:IncUC51.1.3}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-51.1.4 e delle sue inclusioni}
    \label{fig:IncUC51.1.4}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-51.1.5 e delle sue inclusioni}
    \label{fig:IncUC51.1.5}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-51.1.6 e delle sue inclusioni}
    \label{fig:IncUC51.1.6}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    ...
    \caption{Diagramma delle inclusioni dell'UC-52}
    \label{fig:IncUC52}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-53 e delle sue estensioni}
    \label{fig:UC53-ExtUC54}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
...
\begin{figure}[H]
    ...
    \caption{Diagramma dell'UC-55 e delle sue estensioni}
    \label{fig:UC55-ExtUC56}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
...
\begin{figure}[H]
    ...
    \caption{Diagramma delle inclusioni dell'UC-57}
    \label{fig:IncUC57}
\end{figure}
