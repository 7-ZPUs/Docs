...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC43.png}
    \caption{\ref{visualizzaDescrizioneDocumento} - Visualizzazione descrizione documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC44.png}
    \caption{\ref{visualizzaListaSoggettiCoinvolti} - Visualizzazione lista soggetti coinvolti nel documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC44INC.png}
    \caption{Inclusioni \ref{visualizzaListaSoggettiCoinvolti} - Visualizzazione lista soggetti coinvolti nel documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC44.1.png}
    \caption{Generalizzazione \ref{visualizzaInfoSoggettoCoinvolto} - Visualizzazione informazioni soggetto coinvolto in un documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC44.1INC.png}
    \caption{Inclusioni \ref{visualizzaInfoSoggettoCoinvolto} - Visualizza informazioni soggetto coinvolto in un documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC44.1.1INC.png}
      \caption{Inclusioni \ref{visualizzaInfoPF} - Visualizza informazioni del soggetto persona fisica}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC44.1.2INC.png}
      \caption{Inclusioni \ref{visualizzaInfoPG} - Visualizza informazioni del soggetto persona giuridica}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC44.1.3INC.png}
    \caption{Inclusioni \ref{visualizzaInfoAS} - Visualizza informazioni del soggetto AS}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC44.1.4INC.png}
    \caption{Inclusioni \ref{visualizzaInfoPAI} - Visualizza informazioni del soggetto PAI}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC44.1.5INC.png}
    \caption{Inclusioni \ref{visualizzaInfoPAE} - Visualizza informazioni del soggetto PAE}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC44.1.6INC.png}
    \caption{Inclusioni \ref{visualizzaInfoSW} - Visualizza informazioni del soggetto SW}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC45.png}
    \caption{\ref{visualizzaInfoClassificazioneDocumento} - Visualizzazione informazioni di classificazione del documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC45INC.png}
    \caption{Inclusioni \ref{visualizzaInfoClassificazioneDocumento} - Visualizzazione informazioni di classificazione del documento}
...
\begin{figure}[H]
    ...
    \caption{\ref{visualizzaTempoConservazioneEffettivoDocumento} - Visualizza tempo di conservazione effettivo documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/uml/UC48.png}
    \caption{\ref{visualizzaNoteDocumento} - Visualizza note documento}
...
\begin{figure}[H]
    ...
    \caption{\ref{visualizzaDatiRegistrazioneDocumento} - Visualizza Dati di Registrazione documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/UC50INC.png}
    \caption{Inclusioni \ref{visualizzaDatiRegistrazioneDocumento} - Visualizza Dati di Registrazione documento}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video la tipologia del flusso del documento selezionato tra le seguenti:
            \begin{itemize}
                \item In uscita
                \item In entrata
                \item Interno
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            ...
            del documento selezionato tra le seguenti tipologie:
            \begin{itemize}
                \item Protocollo ordinario
                \item Protocollo emergenza
                \item Repertorio
                \item Registro
            \end{itemize}
        \end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video la data di registrazione del documento selezionato
        \end{enumerate}
\end{itemize}

\subsubusecase{visualizzaDataNonProtocollato}{Visualizza data di registrazione documento non protocollato}
\begin{itemize}
\item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
        \item L'utente ha avviato l'applicazione
        \item L'utente ha selezionato un documento non protocollato
    \end{enumerate}
    \item \textbf{Postcondizioni}: L'utente visualizza la data di registrazione del documento non protocollato selezionato
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video la data di registrazione del documento non protocollato selezionato
        \end{enumerate}
    \item \textbf{Specializza}: \ref{visualizzaDataRegistrazioneDocumento} Visualizza data di registrazione documento
\end{itemize}

\subsubusecase{visualizzaDataProtocollato}{Visualizza data di protocollazione documento protocollato}
\begin{itemize}
\item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
        \item L'utente ha avviato l'applicazione
        \item L'utente ha selezionato un documento protocollato
    \end{enumerate}
    \item \textbf{Postcondizioni}: L'utente visualizza la data di protocollazione del documento protocollato selezionato
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video la data di protocollazione del documento protocollato selezionato
        \end{enumerate}
    \item \textbf{Specializza}: \ref{visualizzaDataRegistrazioneDocumento} Visualizza data di registrazione documento
\end{itemize}
...
\subsubusecase{visualizzaNumeroNonProtocollato}{Visualizza numero documento non protocollato}
\begin{itemize}
\item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
        ...
        \item L'utente ha selezionato un documento non protocollato
    \end{enumerate}
    \item \textbf{Postcondizioni}: L'utente visualizza il numero di registrazione del documento non protocollato selezionato
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video il numero di registrazione del documento non protocollato selezionato
        \end{enumerate}
    \item \textbf{Specializza}: \ref{visualizzaNumeroDocumento} Visualizza numero del documento
\end{itemize}

\subsubusecase{visualizzaNumeroProtocollato}{Visualizza numero documento protocollato}
\begin{itemize}
\item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
        ...
        \item L'utente ha selezionato un documento protocollato
    \end{enumerate}
    \item \textbf{Postcondizioni}: L'utente visualizza il numero di protocollo del documento protocollato selezionato
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item Il sistema mostra a video il numero di protocollo del documento protocollato selezionato
        \end{enumerate}
    \item \textbf{Specializza}: \ref{visualizzaNumeroDocumento} Visualizza numero del documento
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{\ref{visualizzaTipologiaDocumentaleDocumento} - Visualizza tipologia documentale documento}
...
\begin{figure}[H]
    ...
    \caption{\ref{visualizzaModalitaFormazioneDocumento} - Visualizza modalità di formazione documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC53.png}
    \caption{\ref{visualizzaStatoRiservatezzaDocumento} - Visualizza stato di riservatezza documento}
