...
\begin{table}[H]
    \centering
    \begin{adjustwidth}{-2.5cm}{-2.5cm} % Ridotto a -2.5 per centrare meglio
    \centering
    \begin{tabular}{|c|c|l|l|p{7.5cm}|}
        \hline
        \textbf{Versione} & \textbf{Data} & \textbf{Autore} & \textbf{Verificatore} & \textbf{Descrizione} \\
        \hline
        0.7.1 & 2026/01/05 & Georgescu Diana & Rocco Matteo A. & Aggiunta lista inclusioni ed estensioni Use Case \\
        \hline
        0.7.0 & 2025/12/28 & Soligo Lorenzo & Vigolo Davide & Aggiunta \hyperref[visualizzaNoteDocumento]{[UC-27]} $\rightarrow$ \hyperref[visualizzaTipoAggregazione]{[UC-42]} \\
        \hline
        0.6.0 & 2025/12/28 & Vigolo Davide & Soligo Lorenzo & Aggiunta \hyperref[stampaInsiemeDoc]{[UC-14]} $\rightarrow$ \hyperref[visualizzaTempoConservazioneEffettivoDocumento]{[UC-26]} \\
        \hline
        0.5.0 & 2025/12/28 & Vigolo Davide & Soligo Lorenzo & Aggiunta \hyperref[validazioneCampi]{[UC-10]} $\rightarrow$ \hyperref[stampaSingoloDoc]{[UC-13]} \\
        \hline
        0.4.0 & 2025/12/28 & Fattoni Antonio & Vigolo Davide & Aggiunta \hyperref[campoNonValido]{[UC-5]} $\rightarrow$ \hyperref[visualizzaRisultati]{[UC-8]} \\
        \hline
        0.3.0 & 2025/12/28 & Soligo Lorenzo & Fattoni Antonio & Aggiunta \hyperref[strutturaDIP]{[UC-1]} $\rightarrow$ \hyperref[ricercaDIP]{[UC-4]} \\
        \hline
        0.2.0 & 12/12/2025 & Soligo Lorenzo & Rocco Matteo A. & Integrazione dei contenuti dal file condiviso (LLM), divisione file per lavorazione asincrona. \\
        \hline
        0.1.0 & 07/11/2025 & Georgescu Diana & Laoud Zakaria & Creazione del template e stesura iniziale \\
        \hline
    \end{tabular}
    \end{adjustwidth}
\end{table}
