...
\section*{Tabella di Versionamento}
    ...
    \begin{longtable}{|c|c|c|c|c|}
        ...
        \hline
        1.0.0 & 2026/02/13 & Laoud Zakaria & Fattoni Antonio & \begin{tabular}[c]{@{}c@{}} Controlli finali e approvazione \end{tabular} \\
        \hline
...
\begin{itemize}
    ...
    \item Possibilità di ricercare i documenti per attributi significativi (\glossario{metadata}).
    ...
    \item Possibilità di visualizzare lo stato dell'eventuale firma digitale associata al file.
\end{itemize}
