...
\begin{figure}[H]
      ...
      \caption{Inclusioni \ref{ricercaDIP} - Ricerca nel DIP}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente visualizza il nome dell'elemento (\ref{visualizzazioneNomeDocumento}).
            \item L'Utente visualizza il tipo di elemento tra Documento, Aggregazione, Processo e Classe Documentale.
      \end{enumerate}
      \item \textbf{Inclusioni}:
      \begin{itemize}
            \item \ref{visualizzazioneNomeDocumento} Visualizza Nome Documento
