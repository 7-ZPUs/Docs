...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{itemize}
                  ...
                  \item Validazione dei campi (UC-??)
            \end{itemize}
      \item \textbf{Flusso alternativo}:
\end{itemize}

\subsubsection{UC-2b Ricerca nel DIP semantica}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{itemize}
...
\subsubsection{UC-* Imposta precisione di ricerca semantica}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Validazione del formato per i campi che lo richiedano ()
...
\subsubsection{UC-3.1.5 - Aggiunta filtro tipo documento}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \item L'Utente ha avviato l'applicazione.
      \item \textbf{Postcondizioni}:  Il filtro aggiunto dall'utente è parametro per la ricerca e per la generazione del risultato.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
...
\subsubsection{UC-3.1.6 - Aggiunta filtro soggetti}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\subsubsection{UC-3.1.6.1 - Aggiunta filtro soggetti per Documento Informatico}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\subsubsection{UC-3.1.6.2 - Aggiunta filtro soggetti per Documento Amministrativo informatico}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\subsubsection{UC-3.1.6.3 - Aggiunta filtro soggetti per Aggregazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente può aggiungere i filtri specifici per il tipo Aggregazione (descritto negli UC da 3.2.2.1 a 3.2.2.10).
            \end{enumerate}
\end{itemize}
...
\paragraph{UC-3.2.2.7.1 - Aggiunta filtro Fasi del Procedimento Amministrativo}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\subsubsection{UC-3.4 - Ricerca per Campi custom}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Per ogni elemento, vengono mostrate le informazioni principali (Nome, Data,
                        Tipo).
                  \item L'Utente può visualizzare ulteriori informazioni e funzioni selezionando uno dei documenti (UC-1.4)
            \end{enumerate}
...
\subsubsection{UC- - Validazione campi}
\begin{itemize}
...
\subsubsection{UC- - Validazione campi di testo libero}
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
...
\subsubsection{UC- - Validazione campi di identificativi IPA}
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
...
\subsubsection{UC- - Validazione campi di codici fiscali}
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi di codici identificativi che richiedono un controllo di validità.
      \item \textbf{Postcondizioni}: Il campo considerato valido viene aggiunto ai parametri di ricerca.
...
\subsubsection{UC- - Validazione campi di soggetti}
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi di testo libero che richiedono un controllo di validità.
      \item \textbf{Postcondizioni}: Il campo considerato valido viene aggiunto ai parametri di ricerca.
...
\subsubsection{UC- - Validazione campi di email}
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi di testo libero che richiedono un controllo di validità.
      \item \textbf{Postcondizioni}: Il campo considerato valido viene aggiunto ai parametri di ricerca.
...
\subsubsection{UC- - Validazione campi di partita IVA}
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi di testo libero che richiedono un controllo di validità.
      \item \textbf{Postcondizioni}: Il campo considerato valido viene aggiunto ai parametri di ricerca.
