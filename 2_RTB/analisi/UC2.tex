...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema produce i risultati di ricerca in base ai criteri specificati
            \item L'Utente visualizza i risultati di ricerca (\ref{visualizzazioneRisultatiRicerca})
      \end{enumerate}
      \item \textbf{Flusso Alternativo}:
      \begin{itemize}
            \item La ricerca non produce risultati e il sistema informa l'Utente (\ref{nessunRisultato})
      \end{itemize}
      \item \textbf{Inclusioni}: \ref{visualizzazioneRisultatiRicerca} Visualizzazione Risultati di Ricerca
...
\subsubusecase{selezionaCampiDI-DAI}{Selezione campi di ricerca per DI/DAI}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\deepusecase{visualizzaListaCampiDIDAI}{Visualizza lista campi DI/DAI}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\subsubusecase{selezionaCampiAggregazioneDocumentale}{Selezione campi di ricerca per Aggregazione Documentale}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\deepusecase{visualizzaListaCampiAggregazioneDocumentale}{Visualizza lista campi Aggregazione Documentale}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
%      \begin{itemize}
%            \item Il sistema comunica che la ricerca non ha prodotto alcun %risultato (\ref{nessunRisultato})
%      \end{itemize}

\item \textbf{Inclusioni}:
      \begin{itemize}
            \item \ref{infoRisultatiRicerca} Informazioni Elenco Elementi
      \end{itemize}
\end{itemize}
