...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{itemize}
                  \item L'Utente aggiunge filtri come parametri per la ricerca(UC-\ref{aggiuntaFiltriRicercaDocumento})
                  \item Il sistema valida i campi (UC-\ref{validazioneCampi})
            \end{itemize}
      \item \textbf{Flusso alternativo}:
      \item \textbf{Inclusioni}: UC-\ref{aggiuntaFiltriRicercaDocumento}, UC-\ref{validazioneCampi}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item L'Utente ha avviato l'applicazione
        \item Il sistema ha una connesione attiva
    \end{itemize}
    \item \textbf{Postcondizioni}:
    \begin{itemize}
        \item L'Utente visualizza i risultati di ricerca per la stringa di query specificata
    \end{itemize}
    \item \textbf{Flusso principale}:
    \begin{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta visualizzando la lista delle Classi Documentali.
      \end{itemize}
      \item \textbf{Postcondizioni}: L'Utente visualizza l'elenco delle Classi Documentali corrispondenti ai filtri applicati.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i filtri per la ricerca secondo i metadati delle Classi
                        Documentali.
                  \item Il sistema mostra i risultati della ricerca (UC-\ref{visualizzaRisultati}).
            \end{enumerate}
      ...
      \item \textbf{Inclusioni}: UC-\ref{visualizzaRisultati}
...
\begin{itemize}
      ...
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta visualizzando la lista dei Processi.
      \end{itemize}
      \item \textbf{Postcondizioni}: L'Utente visualizza l'elenco dei Processi corrispondenti ai filtri applicati.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente imposta uno o più filtri per la ricerca tra campi comuni (UC-\ref{aggiuntaFiltriComuni})
                  ...
                  \item L'Utente imposta uno o più filtri Custom (UC-\ref{addCustomMetadata}).
            \end{enumerate}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente seleziona uno o più campi comuni su cui basare la ricerca (da UC-\ref{addChiaveDescrittiva}
...
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: L'Utente ha scelto un tipo di documento.
      \item \textbf{Postcondizioni}:  Il filtro aggiunto dall'Utente è parametro per la ricerca e per la generazione del risultato.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente sceglie il Ruolo e i sottocampi specifici tra:
                        \begin{itemize}
                              ...
                              \item Altro(PF, PG, PAI valido solo come mittente nei flussi in entrata, come
                                    ...
                                    entrata, come destinatario nei flussi in uscita)
                        \end{itemize}
                  \item Per ogni ruolo, l'Utente può specificare ulteriori dettagli (UC-\ref{addDettagliSoggetto}).
            \end{enumerate}
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente può aggiungere i filtri specifici per il tipo selezionato (descritto
                        negli UC da \ref{aggiuntaFiltriDI-DAI} a \ref{aggiuntaFiltriAggregazione}).
            \end{enumerate}
\end{itemize}
...
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: L'Utente sta effettuando una ricerca per campi specifici al tipo Documento Informatico o Amministrativo Informatico.
      \item \textbf{Postcondizioni}:  Il filtro aggiunto dall'Utente è parametro per la ricerca e per la generazione del risultato.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente può aggiungere i filtri specifici per il tipo Documento Informatico e
                        Amministrativo Informatico (descritto negli UC da \ref{addDatiRegistrazione} a \ref{addTracciatureModificheDocumento}).
            \end{enumerate}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente può aggiungere i filtri specifici per il tipo Aggregazione (descritto negli UC da \ref{addTipoAggregazione} a \ref{addProgressivo}).
            \end{enumerate}
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente inserisce il Catalogo dei Procedimenti come URI di pubblicazione del
                        catalogo.
                  \item  L'Utente può aggiungere una o più Fasi come filtro (UC-\ref{addFasiProcedimentoAmministrativo}).
            \end{enumerate}
\end{itemize}
            ...
            \begin{enumerate}
                  ...
                  \item L'Utente inserisce i dati:
                        \begin{itemize}
                              ...
                              \item Soggetto Assegnatario (UC-\ref{addSoggetti}).
                              \item Data di Inizio.
                              \item Data di Fine.
                        \end{itemize}
            \end{enumerate}
...
\deepusecase{addProgressivo}{UC-3.2.2.9 - Aggiunta filtro Progressivo}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: L'Utente ha scelto come tipo di documento l'Aggregazione Documentale.
      \item \textbf{Postcondizioni}:  Il filtro aggiunto dall'Utente è parametro per la ricerca e per la generazione del risultato.
...
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: L'Utente ha eseguito una ricerca (tramite UC-\ref{ricercaDIPConFiltri}, UC-\ref{ricercaDIPSemantica}).
...
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: L'Utente ha eseguito una ricerca (tramite UC-2).
...
\begin{itemize}
      ...
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi che richiedono un controllo di validità.
...
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi di testo libero che richiedono un controllo di validità.
      \item \textbf{Postcondizioni}: Il campo considerato valido viene aggiunto ai parametri di ricerca.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
...
\begin{itemize}
      \item \textbf{Attore Primario}: Sistema
      \item \textbf{Precondizioni}: L'Utente ha compilato dei campi di codici identificativi che richiedono un controllo di validità.
      \item \textbf{Postcondizioni}: Il campo considerato valido viene aggiunto ai parametri di ricerca.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
