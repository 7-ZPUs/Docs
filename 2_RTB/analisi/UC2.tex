...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../assets/uml/UC14INC.png}
      \caption{Inclusioni UC14 - Ricerca nel DIP}
      \label{fig:inclusioniRicercaDIP}
\end{figure}

\subusecase{ricercaDIPConFiltri}{Ricerca nel DIP con filtri}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../assets/uml/UC14.1.png}
    \caption{UC14.1 - Ricerca nel DIP con filtri}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../assets/uml/UC14.1INC.png}
      \caption{Inclusioni UC14.1 - Ricerca nel DIP con filtri}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.6\textwidth]{../assets/uml/UC14.3INC.png}
      \caption{Inclusioni UC14.3 - Ricerca Classe Documentale per Nome}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.6\textwidth]{../assets/uml/UC14.4INC.png}
      \caption{Inclusioni UC14.4 - Ricerca Processo per Id}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../assets/uml/UC16.png}
    \caption{UC16 - Indicizza DIP con engine semantico}
    \label{fig:uc_indicizzazioneSemantica}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC18.png}
    \caption{UC18 - Visualizza stato indicizzazione semantica}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{../assets/uml/UC19.1.png}
      \caption{UC19.1 - Specifica filtri per Campi Comuni}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../assets/uml/UC19.2.png}
    \caption{UC19.2 - Specifica filtri per Tipo di Documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC19.2.1.png}
    \caption{UC19.2.1 - Specifica filtri per Documento Informatico e Amministrativo Informatico}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{../assets/uml/UC19.2.1INC.png}
      \caption{Inclusioni UC19.2.1 - Specifica filtri per Documento Informatico e Amministrativo Informatico}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC19.2.2.png}
    \caption{UC19.2.2 - Specifica filtri per Aggregazione Documentale}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{../assets/uml/UC19.2.2INC.png}
      \caption{Inclusioni UC19.2.2 - Specifica filtri per Aggregazione Documentale}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../assets/uml/UC19.3INC.png}
      \caption{Inclusioni UC19.3 - Specifica filtri per Custom Metadata}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{../assets/uml/UC20INC.png}
      \caption{Inclusioni UC20 - Aggiunta Soggetto ad un filtro}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{../assets/uml/UC20.3.png}
      \caption{UC20.3 - Specifica dettagli soggetto}
      \label{fig:uc_SpecificaDettagliSoggetto}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.6\textwidth]{../assets/uml/UC22.png}
      \caption{UC22 - Visualizzazione Risultati di Ricerca}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../assets/uml/UC22INC.png}
      \caption{Inclusioni UC22 - Informazioni Elenco Elementi}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.6\textwidth]{../assets/uml/UC23.png}
      \caption{UC23 - Nessun Risultato}
      \label{fig:uc_NessunRisultato}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
