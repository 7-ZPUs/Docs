...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'utente aggiunge uno o più soggetti come filtro di ricerca.
...
\paragraph{UC-2.3.1.2.1 - Ricerca per Dettagli Ruolo= PAI}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
...
\paragraph{UC-2.3.1.2.2 - Ricerca per Dettagli Ruolo= PAE}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
...
\paragraph{UC-2.3.1.2.3 - Ricerca per Dettagli Ruolo= AS}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
...
\paragraph{UC-2.3.1.2.4 - Ricerca per Dettagli Ruolo= PG}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
...
\paragraph{UC-2.3.1.2.5 - Ricerca per Dettagli Ruolo= PF}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
...
\paragraph{UC-2.3.1.2.6 - Ricerca per Dettagli Ruolo= RUP}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
...
\paragraph{UC-2.3.1.2.7 - Ricerca per Dettagli Ruolo= SW}
\begin{itemize}
      \item \textbf{Attore Primario}: utente
