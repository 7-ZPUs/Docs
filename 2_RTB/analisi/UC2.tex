...
\begin{itemize}
      ...
      \item \textbf{Flusso alternativo}: 
            \begin{itemize}
                  ...
                  \item La ricerca non produce risultati e il sistema informa l'Utente (\ref{nessunRisultato})
            \end{itemize}
      \item \textbf{Inclusioni}: \ref{specificaFiltriRicercaDocumento}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Il sistema produce i risultati di ricerca in base al Nome inserito
            \end{enumerate}
      \item \textbf{Flusso Alternativo}: La ricerca non produce risultati e il sistema informa l'Utente (\ref{nessunRisultato}).
      \item \textbf{Estensioni}: \ref{nessunRisultato}
      \item \textbf{Specializza}: \ref{ricercaDIP}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            ...
            \end{enumerate}
      \item \textbf{Flusso Alternativo (Nessun risultato)}: La ricerca non produce risultati e il sistema informa l'Utente (\ref{nessunRisultato}).
      \item \textbf{Estensioni}: \ref{nessunRisultato}
      \item \textbf{Specializza}: \ref{ricercaDIP}
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente specifica i filtri per la ricerca tra campi specifici per tipo
                        documentale (\ref{addFiltriTipoDocumento}).
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente specifica i filtri per i campi selezionati (da \ref{addChiaveDescrittiva}
                        a \ref{addSoggetti}).
                  % \item Validazione del formato per i campi che lo richiedano (\ref{validazioneCampi}).
            \end{enumerate}
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Classificazione tra:
                        \begin{itemize}
                              \item Indice di Classificazione (\ref{compilaValoreFiltro})
                              \item Descrizione (\ref{compilaValoreFiltro})
                              \item Piano di Fascicolo (\ref{compilaValoreFiltro})
                        \end{itemize}
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                    ...
                    \end{itemize}. (\ref{compilaValoreFiltro})
                    \item Il sistema imposta il valore come parametro per la ricerca.
            \end{enumerate}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            ...
            \end{enumerate}
      \item \textbf{Specializza}: \ref{specificaFiltriTipoDocumento}
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica la Tipologia di Flusso (\ref{compilaValoreFiltro}) tra: \begin{itemize}
                              ...
                              \item Interno.
                        \end{itemize}
                  \item L'Utente specifica il Tipo di Registro (\ref{compilaValoreFiltro}) tra: \begin{itemize}
                              \item Nessuno,
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica il tipo di aggregazione (\ref{compilaValoreFiltro}) tra:\begin{itemize}
                              \item Fascicolo,
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente specifica il Catalogo dei Procedimenti come URI di pubblicazione del
                        catalogo. (\ref{compilaValoreFiltro})
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'utente specifica, per ogni fase da aggiungere, i dati specifici (\ref{addFasiProcedimentoAmministrativo}):
                  \begin{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i dettagli del tipo di soggetto specificato. (\ref{addDettagliPAI}-\ref{addDettagliSW})
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            \end{enumerate}
      \item \textbf{Specializza}: \ref{aggDettagliSoggetto}
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Per ogni elemento, vengono mostrate le informazioni principali (Nome, Data,
                        Tipo).
                  \item L'Utente può visualizzare ulteriori informazioni e funzioni selezionando uno dei documenti (\ref{informazioniElemento})
            \end{enumerate}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente visualizza la data di creazione o di registrazione del documento o
                        dell'aggregazione (\ref{visualizzaDataRegistrazioneDocumento}).
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Il sistema aggiunge gli elementi selezionati ai campi selezionati per la ricerca.
            \end{enumerate}
      \item \textbf{Specializza}: \ref{selezionaCampiTipoDocumento}
\end{itemize}
