\usecase{ricercaDIP}{Ricerca nel DIP (Astratto)}
\begin{itemize}
...
\usecase{ricercaDIPConFiltri}{Ricerca nel DIP con filtri}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize} 
...
\usecase{ricercaDIPSemantica}{Ricerca nel DIP semantica}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{itemize}
...
\usecase{ricercaClasse}{Ricerca Classe Documentale per Nome}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize} 
...
\usecase{ricercaProcesso}{Ricerca Processo per Id}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\begin{itemize}
      ...
      \begin{itemize}
            ...
            \item \ref{addCustomMetadata} Specifica filtri Custom
      \end{itemize}
\end{itemize}
...
\subusecase{specificaFiltriDI-DAI}{Specifica filtri per Documento Informatico e Amministrativo Informatico}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
      ...
      \end{itemize}
      \item \textbf{Specializza}: \ref{specificaFiltriTipoDocumento} Specifica filtri per Tipo di Documento
\end{itemize}

\subsubusecase{addDatiRegistrazione}{Specifica filtro Dati di Registrazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addTipologiaDocumentale}{Specifica filtro Tipologia Documentale}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addModalitaFormazione}{Specifica filtro Modalità di Formazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addRiservato}{Specifica filtro campo Riservato}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addIdentificativoFormato}{Specifica filtro Identificativo di Formato}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addDatiVerifica}{Specifica filtro Dati di Verifica}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addNomeDocumento}{Specifica filtro Nome del Documento}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addVersioneDocumento}{Specifica filtro Versione del Documento}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addIdentificativoDocumentoPrimario}{Specifica filtro Identificativo del Documento Primario}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:
      \begin{itemize}
...
\subsubusecase{addTracciatureModificheDocumento}{Specifica filtro Tracciature Modifiche di Documento}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subusecase{specificaFiltriAggregazione}{Specifica filtri per Aggregazione Documentale Informatica}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
      ...
      \end{itemize}
      \item \textbf{Specializza}: \ref{specificaFiltriTipoDocumento} Specifiche filtri per Tipo di Documento
\end{itemize}

\subsubusecase{addTipoAggregazione}{Specifica filtro Tipo di Aggregazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addIdAggregazione}{Specifica filtro Id dell'Aggregazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addTipologiaFascicolo}{Specifica filtro Tipologia di Fascicolo}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addIdAggregazionePrimario}{Specifica filtro Id Aggregazione Primario}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addDataApertura}{Specifica filtro Data Apertura}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addDataChiusura}{Specifica filtro Data Chiusura}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addProcedimentoAmministrativo}{Specifica filtro Procedimento Amministrativo}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema imposta i valori del filtro come parametri di ricerca.
      \end{enumerate}
      \item \textbf{Inclusioni}: \ref{addFasiProcedimentoAmministrativo} Aggiunta Fase del Procedimento Amministrativo
\end{itemize}
      
\deepusecase{addFasiProcedimentoAmministrativo}{Aggiunta Fase del Procedimento Amministrativo}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addAssegnazione}{Specifica filtro Assegnazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\deepusecase{addAssegnazione}{Aggiunta Valore Assegnazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subsubusecase{addProgressivoAggregazione}{Specifica filtro Progressivo Aggregazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\usecase{addDettagliSoggetto}{Specifica dettagli soggetto}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
...
\subusecase{addDettagliPAI}{Specifica dettagli soggetto tipo: PAI}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            \end{enumerate}
      \item \textbf{Specializza}: \ref{aggDettagliSoggetto} Specifica dettagli soggetto
\end{itemize}

\subusecase{addDettagliPAE}{Specifica dettagli soggetto tipo: PAE}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\subusecase{addDettagliAS}{Specifica dettagli soggetto tipo: AS}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:\begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\subusecase{addDettagliPG}{Specifica dettagli soggetto tipo: PG}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\subusecase{addDettagliPF}{Specifica dettagli soggetto tipo: PF}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\subusecase{addDettagliRUP}{Specifica dettagli soggetto tipo: RUP}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\subusecase{addDettagliSW}{Specifica dettagli soggetto tipo: SW}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Per ogni elemento, vengono mostrate le informazioni principali (Nome, Data, Tipo).
      ...
      \begin{itemize}
            \item Il sistema comunica che la ricerca non ha prodotto alcun risultato (\ref{nessunRisultato}) % già presente come alternativa a uc di ricerca
      \end{itemize}
\end{itemize}
...
\usecase{selezionaCampiDI-DAI}{Selezione campi di ricerca per DI/DAI}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
...
\usecase{selezionaCampiAggregazioneDocumentale}{Selezione campi di ricerca per Aggregazione Documentale}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
            \item L'Utente ha avviato l'applicazione
