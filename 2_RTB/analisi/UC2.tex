...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item Il sistema valida il formato del Nome (UC-\ref{validazioneTestoLibero}).
      ...
      \item \textbf{Estensioni}: UC-\ref{nessunRisultato}
      \item \textbf{Specializza}: UC-\ref{ricerca}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente sceglie il Tipo di Documento. (UC-\ref{addTipoDocumento})
...
\begin{itemize}
      ...
      \begin{itemize}
            ...
            \item L'Utente ha scelto un ruolo come campo di ricerca secondo le modalità descritte negli UC-\ref{addSoggettiDocInfo}-\ref{addSoggettiAgg}
      \end{itemize}
      \item \textbf{Postcondizioni}:  Il filtro aggiunto dall'Utente è parametro per la ricerca e per la generazione del risultato.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
