...
\begin{itemize}
    ...
    \begin{itemize}
        \item ref{elencoVuoto}{Visualizza elenco vuoto}
    \end{itemize}
\end{itemize}

\usecase{processoClassedDocumentale}{Visualizza processi in elenco}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
...
\begin{itemize}
    ...
    \item \textbf{Estensioni}:
    \begin{itemize}
        \item \ref{formatoDocumentoNonSupportato} Formato Documento non Supportato dal Sistema per l'anteprima
    \end{itemize}
\end{itemize}
