...
\begin{figure}[H]
    ...
    \caption{\ref{classeDocumentale} - Visualizza classe documentale in elenco}
...
\begin{figure}[H]
    ...
    \caption{Inclusioni \ref{classeDocumentale} - Visualizza nome classe documentale}
...
\subusecase{processoClasseDocumentale}{Visualizza processi in elenco}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC4.png}
    \caption{\ref{processoClasseDocumentale} - Visualizza processi in elenco}
...
\begin{figure}[H]
    ...
    \caption{Inclusioni \ref{processoClasseDocumentale} - Visualizza elenco dei documenti di un processo}
...
\begin{figure}[H]
    ...
    \caption{\ref{documentoProcesso} - Visualizza documento in elenco}
...
\begin{figure}[H]
    ...
    \caption{Inclusioni \ref{documentoProcesso} - Visualizza elenco dei documenti di un processo}
