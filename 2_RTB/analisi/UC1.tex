    ...
    \item \textbf{Flusso Principale}:
          \begin{enumerate}
              \item L'Utente visualizza l'albero del DIP. L'albero è organizzato gerarchicamente in:
                    \begin{itemize}
                        \item Classi Documentali $\rightarrow$ Vedi \hyperref[classiDocumentali]{[UC-1.\ref{classiDocumentali}]}
                        \item Processi $\rightarrow$ Vedi \hyperref[processiClasseDocumentale]{[UC-1.\ref{processiClasseDocumentale}]}
                        \item Documenti $\rightarrow$ Vedi \hyperref[documentiProcesso]{[UC-1.\ref{documentiProcesso}]}
                    \end{itemize}
          \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Inclusioni}: 
        \begin{itemize}[label=$\rhd$]
            \item \hyperref[nomeElemento]{[UC-1.\ref{nomeElemento}]}
            \item \hyperref[statoVerificaElemento]{[UC-1.\ref{statoVerificaElemento}]}
            \item \hyperref[marcaturaTemporaleElemento]{[UC-1.\ref{marcaturaTemporaleElemento}]}
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Estensioni}:
        \begin{itemize}[label=$\rhd$]
    \item \hyperref[formatoDocumentoNonSupportato]{[UC-\ref{formatoDocumentoNonSupportato}]} - Formato Documento non Supportato dal Sistema
\end{itemize}
\end{itemize}
