...
\begin{figure}[H]
    ...
    \caption{UC61 - Visualizza informazioni dell'identificativo di formato}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC61.png}
    \caption{Inclusioni UC61 - Visualizza informazioni dell'identificativo di formato}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}: 
    \begin{enumerate} 
        \item Il sistema mostra a video il tipo di formato del documento tra quelli indicati nelle Linee guida AGID
    \end{enumerate}
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{UC62 - Visualizza informazioni di verifica}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC62.png}
    \caption{Inclusioni UC62 - Visualizza informazioni di verifica}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate} 
        \item Il sistema mostra a video se vi è conformità alle copie immagine su supporto informatico (sì/no)
    \end{enumerate}
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{UC63 - Visualizza versione del documento}
...
\begin{figure}[H]
    ...
    \caption{UC64 - Visualizza nome del documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/uml/UC65-ExtUC65.6.png}
    \caption{UC65 - Visualizza informazioni sugli allegati}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item L'utente visualizza le informazioni identificative degli allegati, se presenti, quali:
        \begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC65-ExtUC65.3.UC65.5.png}
    \caption{Inclusioni UC65 - Visualizza informazioni sugli allegati}
...
\subusecase{erroreIdentificativoAllegato}{Errore Visualizzazione identificativo allegato}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
...
\subusecase{erroreDescrizioneAllegato}{Errore Visualizzazione descrizione allegato}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    \begin{enumerate}
...
\begin{figure}[H]
    ...
    \caption{UC66 - Visualizza informazioni sulle modifiche di un documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC66.png}
    \caption{Inclusioni UC66 - Visualizza informazioni sulle modifiche di un documento}
...
\begin{figure}[H]
    ...
    \caption{UC67 - Visualizza tipo di aggregazione}
...
\begin{figure}[H]
    ...
    \caption{UC68 - Visualizza identificativo di aggregazione}
...
\begin{figure}[H]
    ...
    \caption{UC69 - Visualizza tipologia di fascicolo}
...
\begin{figure}[H]
    ...
    \caption{UC70 - Visualizza assegnazione di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC70.png}
    \caption{Inclusioni UC70 - Visualizza assegnazione di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC71.png}
    \caption{UC71 - Visualizza data di apertura di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC72.png}
    \caption{UC72 - Visualizza data di chiusura di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC73.png}
    \caption{UC73 - Visualizza progressivo di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC74.png}
    \caption{UC74 - Visualizza procedimento amministrativo di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC74.png}
    \caption{Inclusioni UC74 - Visualizza procedimento amministrativo di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/IncUC74.4.png}
    \caption{Inclusioni UC74.4 - Visualizza fase procedimento amministrativo}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../assets/uml/IncUC74.4.1.png}
    \caption{Inclusioni UC74.4.1 - Visualizza fase procedimento amministrativo}
    \label{fig:inclusioniVisualizzaFaseProcedimentoAmministrativo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC75.png}
    \caption{UC75 - Visualizza indice dei documenti di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/IncUC75.png}
    \caption{Inclusioni UC75 - Visualizza indice dei documenti di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/IncUC75.1.png}
    \caption{Inclusioni UC75.1 - Visualizza voce dell'indice dei documenti di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC76.png}
    \caption{UC76 - Visualizza posizione fisica di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC77.png}
    \caption{UC77 - Visualizza identificativo dell'aggregazione primaria di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC78.png}
    \caption{UC78 - Visualizza tempo conservazione di aggregazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/uml/UC79-ExtUC79.3.png}
    \caption{UC79 - Visualizza lista metadati custom documento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/uml/UC79.png}
    \caption{Inclusioni UC79 - Visualizza lista metadati custom documento}
