...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            ...
            \item Il sistema verifica l'integrità del DIP completo e delle sue componenti ricorsivamente
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            ...
            \item Il sistema verifica l'integrità della classe documentale e delle sue componenti ricorsivamente
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            ...
            \item Il sistema verifica l'integrità del processo e delle sue componenti ricorsivamente
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            ...
            \item Il sistema verifica l'integrità del documento
...
\begin{itemize}
    ...
    \item \textbf{Inclusioni}: \begin{itemize}
        \item \ref{visualizzaElementoListaClassiCorrotte} Visualizza elemento lista classi corrotte
    \end{itemize}
...
\subsubusecase{visualizzaElementoListaClassiCorrotte}{Visualizza elemento lista classi corrotte}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}: 
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Alternativo}:
        ...
        \end{itemize}
    \item \textbf{Inclusioni}: \begin{itemize}
        \item \ref{visualizzaElementoListaProcessiCorrotti} Visualizza elemento lista processi corrotti
        \end{itemize}
...
\subsubusecase{visualizzaElementoListaProcessiCorrotti}{Visualizza elemento lista processi corrotti}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}: 
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Alternativo}:\begin{enumerate}
        ...
        \end{enumerate}
    \item \textbf{Inclusioni}: \begin{itemize}
        \item \ref{visualizzaElementoListaDocumentiCorrotti} Visualizza elemento lista documenti corrotti
        \end{itemize}
    \item \textbf{Estensioni}: \begin{itemize}
...
\subsubusecase{visualizzaElementoListaDocumentiCorrotti}{Visualizza elemento lista documenti corrotti}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}: 
        \begin{itemize}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{../assets/uml/UC35.png}
      \caption{\ref{convertiReportVerificaPDF} - Converti report verifica in PDF}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/uml/UC36.png}
