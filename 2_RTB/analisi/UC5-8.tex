...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
            \item L'utente sceglie: "Verifica \glossario{integrità} dell'intero DIP"
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Il report di integrità del DIP viene visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Il report di integrità della classe documentale viene visualizzato.   
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Report di integrità del processo visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        \begin{itemize}
            ...
            \item È stata completata una verifica di integrità di un processo            
        \end{itemize} 
    \item \textbf{Postcondizioni}: Numero totale di documenti del processo verificati visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Numero di documenti integri del processo visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}:
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Numero di documenti corrotti del processo visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        \begin{itemize}
            ...
            \item È stata completata una verifica di integrità di un processo
        \end{itemize}    
    \item \textbf{Postcondizioni}: Lista completa dei documenti corrotti del processo visualizzata.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Timestamp della verifica del processo visualizzato.
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        ...
        \end{itemize} 
    \item \textbf{Postcondizioni}: Report di integrità del documento visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        \begin{itemize}
            ...
            \item È stata completata una verifica di integrità di un documento
        \end{itemize} 
    \item \textbf{Postcondizioni}: Stato della verifica del documento visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        \begin{itemize}
            ...
            \item È stata completata una verifica di integrità di un documento
        \end{itemize} 
    \item \textbf{Postcondizioni}: Timestamp della verifica del documento visualizzato.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item L'Utente ha avviato l'applicazione
        \item L'Utente sta visualizzando un \glossario{report} di verifica (DIP completo / Classe Documentale / Processo / Documento)
    ...
    \item \textbf{Flusso Alternativo}:
    \begin{itemize}
        \item La conversione non va a buon fine: il file PDF non viene generato.
        \item Si verifica un errore durante il salvataggio del file PDF: il file non viene scaricato.
    \end{itemize}
    \item \textbf{Estensioni}: 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Alternativo}:
        \begin{itemize}
            ...
            \item Il sistema chiude il dialogo senza salvare.
        \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item È stata scelta l'opzione di conversione in PDF di un report di verifica.
        \end{itemize} 
    \item \textbf{Postcondizioni}: L'utente visualizza un messaggio d'errore.     
    \item \textbf{Flusso Principale}:
        \begin{enumerate}
