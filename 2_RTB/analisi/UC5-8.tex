...
\usecase{esportaReportVerificaPDF}{Esporta report verifica in PDF}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/uml/UC35.png}
      \caption{\ref{esportaReportVerificaPDF} - Esporta report verifica in PDF}
    \label{fig:uc_esportaReportVerificaPDF}
\end{figure}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}:
    ...
    \begin{itemize}
        ...
        \item Si verifica un errore durante il salvataggio del file PDF: viene visualizzato un messaggio di errore "Impossibile salvare il PDF. Riprovare."
    \end{itemize}
    \item \textbf{Estensioni}: 
    \begin{itemize}
