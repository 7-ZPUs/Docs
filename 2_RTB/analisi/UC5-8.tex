...
\begin{itemize}
    ...
    \item \textbf{Inclusioni}: 
        \begin{itemize}
            \item UC-\ref{visualizzazioneNumeroClassiVerificate} Visualizzazione Numero Classi Verificate
            \item UC-\ref{visualizzazioneNumeroClassiIntegre} Visualizzazione Numero Classi Integre
            \item UC-\ref{visualizzazioneNumeroClassiCorrotte} Visualizzazione Numero Classi Corrotte
            \item UC-\ref{visualizzazioneListaClassiCorrotte} Visualizzazione Lista Classi Corrotte
            \item UC-\ref{visualizzazioneDataEOraVerificaDIP} Visualizzazione Data e Ora Verifica DIP.
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Inclusioni}: 
        \begin{itemize}
            \item UC-\ref{visualizzazioneNumeroProcessiVerificati} Visualizzazione Numero Processi Verificati
            \item UC-\ref{visualizzazioneNumeroProcessiIntegri} Visualizzazione Numero Processi Integri
            \item UC-\ref{visualizzazioneNumeroProcessiCorrotti} Visualizzazione Numero Processi Corrotti
            \item UC-\ref{visualizzazioneListaProcessiCorrotti} Visualizzazione Lista Processi Corrotti
            \item UC-\ref{visualizzazioneDataEOraVerificaClasse} Visualizzazione Data e Ora Verifica Classe.
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Inclusioni}: 
        \begin{itemize}
            \item UC-\ref{visualizzazioneNumeroDocumentiVerificati} Visualizzazione Numero Documenti Verificati
            \item UC-\ref{visualizzazioneNumeroDocumentiIntegri} Visualizzazione Numero Documenti Integri
            \item UC-\ref{visualizzazioneNumeroDocumentiCorrotti} Visualizzazione Numero Documenti Corrotti
            \item UC-\ref{visualizzazioneListaDocumentiCorrotti} Visualizzazione Lista Documenti Corrotti
            \item UC-\ref{visualizzazioneDataEOraVerificaProcesso} Visualizzazione Data e Ora Verifica Processo
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Estensioni}: UC-\ref{erroreGenerazionePDF} Errore generazione PDF
\end{itemize}
