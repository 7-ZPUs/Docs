...
\begin{itemize}
    ...
    \item \textbf{Board}: Strumento di gestione del lavoro che consente di visualizzare e organizzare le attività in modo chiaro e intuitivo. Un esempio comune è il Kanban board, che utilizza colonne per rappresentare le diverse fasi del processo di sviluppo (ad esempio, "Da fare", "In corso", "Fatto") e schede per rappresentare le singole attività o task.
...
\begin{itemize}
    ...
    \item \textbf{Sprint}: Un periodo di tempo definito (di solito da 1 a 2 settimane) durante il quale un team di sviluppo software lavora per completare un insieme specifico di attività o obiettivi. Gli sprint sono una componente chiave della metodologia Agile e aiutano a organizzare il lavoro in modo iterativo e incrementale.
