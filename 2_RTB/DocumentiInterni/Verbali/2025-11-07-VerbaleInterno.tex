...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 2025/11/07 & Rocco Matteo A. & Soligo Lorenzo & \begin{tabular}[c]{@{}c@{}}Creazione del verbale\\ e stesura iniziale\end{tabular} \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
...
Considerata l'inesperienza nel ricoprire i ruoli di progetto, è stato stabilito di mantenere i ruoli assegnati durante questo incontro per due Sprint (due settimane), questo per permettere poi di condividere maggiori consigli o accortezze al membro che ricoprirà un determinato ruolo nel prossimo ciclo.
...
\begin{tabular}{|c|c|}
    ...
    \hline
    Gingillino Aaron & Analista/Verificatore \\
    \hline
...
\subsection{Riflessioni su documentazione a seguito della lezione rovesciata del 2025/11/06}
...
\section{Decisioni}
\begin{enumerate}[noitemsep]
    \item Svolgimento primo ciclo di Sprint con i ruoli assegnati, con aggiornamento sull'avanzamento dei lavori il 2025/11/10, 
    ...
    \item Creazione diario di bordo 2025/11/10.
\end{enumerate}
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#0 & Redazione del verbale & \href{https://7zpus.atlassian.net/browse/DIPR-43}{DIPR-43} & Rocco Matteo A. & Soligo Lorenzo \\
    \hline
    \#2 & Modifiche al sito web & \href{https://7zpus.atlassian.net/browse/DIPR-61}{DIPR-61} & Fattoni Antonio & Vigolo Davide \\
    \hline
    \#3 & Stesura Glossario & \href{https://7zpus.atlassian.net/browse/DIPR-20}{DIPR-20} & Vigolo Davide & Gingillino Aaron \\
    \hline
    \#4 & Test connessione Jira-GitHub & \href{https://7zpus.atlassian.net/browse/DIPR-24}{DIPR-24} & Soligo Lorenzo & \begin{tabular}[c]{@{}c@{}} Rocco Matteo A.\\ Vigolo Davide \end{tabular} \\
    \hline
    \#4 & Jira Smart Commit & \href{https://7zpus.atlassian.net/browse/DIPR-25}{DIPR-25} & Soligo Lorenzo & \begin{tabular}[c]{@{}c@{}} Rocco Matteo A.\\ Vigolo Davide \end{tabular} \\
    \hline
    \#4 & \begin{tabular}[c]{@{}c@{}} Documentazione Jira \\nelle Norme di Progetto \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-26}{DIPR-26} & Soligo Lorenzo & \begin{tabular}[c]{@{}c@{}} Rocco Matteo A.\\ Vigolo Davide \end{tabular} \\
    \hline
    \#5 & \begin{tabular}[c]{@{}c@{}} Creazione e validazione \\tabella decisioni \end{tabular} & \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-56}{DIPR-56}\\\href{https://7zpus.atlassian.net/browse/DIPR-57}{DIPR-57} \end{tabular} & Rocco Matteo A. & Soligo Lorenzo \\
    \hline
    \#6 & \begin{tabular}[c]{@{}c@{}} Definizione struttura \\Analisi dei Requisiti  \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-53}{DIPR-53} & Georgescu Diana & Laoud Zakaria\\
    \hline
    \#7 & \begin{tabular}[c]{@{}c@{}} Preparazione e validazione\\Diario di Bordo 2025/11/10 \end{tabular} & \begin{tabular}[c]{@{}c@{}} \href{https://7zpus.atlassian.net/browse/DIPR-51}{DIPR-51}\\\href{https://7zpus.atlassian.net/browse/DIPR-52}{DIPR-52} \end{tabular} & Gingillino Aaron & Georgescu Diana \\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
