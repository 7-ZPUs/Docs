...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    0.1 & 2025/11/28 & Fattoni Antonio & Vigolo Davide & \begin{tabular}[c]{@{}c@{}} Creazione del verbale\\ e stesura iniziale \end{tabular} \\
    \hline
...
\noindent I ruoli assegnati a ciascun membro per questa settimana sono i seguenti. \textbf{Ognuno} svolgerà anche il ruolo di \textbf{verificatore}.
\begin{table}[H]
...
Il gruppo ha deciso di assengare la stesura dell'analisi dei requisiti agli analisti mentre piano di progetto ai responsabili. Le norme di progetto verranno aggiornate da tutti i membri in base al ruolo svolto, i responsabili approveranno le norme scritte basandosi sulle indicazioni dei verificatori che avranno il compito di reperire informazioni sui processi coinvolti e sulle best practice da adottare.
...
\begin{itemize}[noitemsep]
    \item 2025/12/15 si presuppone di avere terminato gran parte dei casi d'uso dell'analisi dei requisiti
...
\begin{enumerate}[noitemsep]
    ...
    \item Si procede alla creazione del diario di bordo del 2025/12/01
    \item Si è deciso di iniziare uno studio sulla stesura del piano di qualifica
    \item Si procede alla stesura del verbale esterno relativo all'incontro con la proponente del 2025/11/27
...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \#2 & \begin{tabular}[c]{@{}c@{}} Scrittura piano \\di progetto \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-100}{DIPR-100}& Responsabili & Responsabili \\
    \hline
    \#3 & \begin{tabular}[c]{@{}c@{}} Aggiornamento \\norme di progetto \end{tabular} & & Responsabili & Responsabili \\
    \hline
    \#4 & \begin{tabular}[c]{@{}c@{}} Creazione slide\\ Diario di bordo\\ 2025/12/01 \end{tabular}& \href{https://7zpus.atlassian.net/browse/DIPR-109}{DIPR-109}& Vigolo Davide & Soligo Lorenzo \\
    \hline
    \#5 & \begin{tabular}[c]{@{}c@{}} Studio piano \\di qualifica \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-113}{DIPR-113} & Rocco Matteo A. & \\
    \hline
    \#6 & \begin{tabular}[c]{@{}c@{}} Stesura verbale \\esterno 2025/11/27 \end{tabular} & \href{https://7zpus.atlassian.net/browse/DIPR-111}{DIPR-111} & Soligo Lorenzo & Laoud Zakaria\\
    \hline
\end{tabular}
    \end{adjustwidth}
\end{table}
