...
\newcommand{\subusecase}[2]{%
    ...
    \addcontentsline{toc}{subsubsection}{\theucSub\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\newcommand{\subsubusecase}[2]{%
    ...
    \addcontentsline{toc}{paragraph}{\theucSubSub\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\newcommand{\deepusecase}[2]{%
    ...
    \addcontentsline{toc}{paragraph}{\theucDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\newcommand{\subdeepusecase}[2]{%
    ...
    \addcontentsline{toc}{paragraph}{\theucSubDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
