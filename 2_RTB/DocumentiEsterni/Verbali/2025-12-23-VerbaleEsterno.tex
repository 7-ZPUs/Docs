...
\begin{enumerate}[noitemsep]
    \item Esposizione da parte del gruppo dello stato di avanzamento dei lavori.
    \item Risoluzione di alcuni dubbi riguardanti le funzionalità del prodotto.
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Domanda 1:} È rilevante la possibilità di ricercare un processo/classe documentale con il suo identificativo nonostante sia una stringa di caratteri alfanumerici poco riconoscibile e pratica per l'utente? \\
