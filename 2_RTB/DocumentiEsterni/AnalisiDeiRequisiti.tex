...
\newcommand{\deepusecase}[2]{%
    ...
    \addcontentsline{toc}{subparagraph}{\protect\hspace{2em}\theucDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\newcommand{\subdeepusecase}[2]{%
    ...
    \addcontentsline{toc}{subparagraph}{\protect\hspace{4em}\theucSubDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\newcommand{\subsubdeepusecase}[2]{%
    ...
    \addcontentsline{toc}{subparagraph}{\protect\hspace{6em}\theucSubSubDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\newcommand{\abyssalusecase}[2]{%
    ...
    \addcontentsline{toc}{subparagraph}{\protect\hspace{8em}\theucAbyssal\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
