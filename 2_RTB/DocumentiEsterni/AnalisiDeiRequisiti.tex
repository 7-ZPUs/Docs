...
\newcommand{\deepusecase}[2]{%
    ...
    \addcontentsline{toc}{subparagraph}{\protect\hspace{1em}\theucDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}

% 6. Contatore 5 (es. UC-3.2.1.1.5)
\newcounter{ucSubDeep}[ucDeep]
...
\newcommand{\subdeepusecase}[2]{%
    ...
    \addcontentsline{toc}{subparagraph}{\protect\hspace{2em}\theucSubDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}

% 7. Contatore 6 (es. UC-3.2.1.1.5.1)
\newcounter{ucSubSubDeep}[ucSubDeep]
\renewcommand{\theucSubSubDeep}{\theucSubDeep.\arabic{ucSubSubDeep}}

\newcommand{\subsubdeepusecase}[2]{%
    \refstepcounter{ucSubSubDeep}%
    \paragraph*{\theucSubSubDeep\ - #2}%
    \addcontentsline{toc}{subparagraph}{\protect\hspace{3em}\theucSubSubDeep\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}

% 8. Contatore 7 (es. UC-3.2.1.1.5.1.1)
\newcounter{ucAbyssal}[ucSubSubDeep]
\renewcommand{\theucAbyssal}{\theucSubSubDeep.\arabic{ucAbyssal}}

\newcommand{\abyssalusecase}[2]{%
    \refstepcounter{ucAbyssal}%
    \paragraph*{\theucAbyssal\ - #2}%
    \addcontentsline{toc}{subparagraph}{\protect\hspace{3em}\theucAbyssal\ - #2}%
    \ifx&#1&\else\label{#1}\fi%
}
...
\setlength{\cftsubparaindent}{2.5em} 
