...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.5\textwidth]{../../assets/uml/UC75INC.png}
      \caption{Inclusioni \ref{visualizzaListaCampiDIDAI} - Visualizza lista campi DI/DAI}
      \label{fig:inclusioniVisualizzaListaCampiDIDAI}
\end{figure}
