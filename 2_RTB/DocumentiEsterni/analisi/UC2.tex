...
\begin{itemize}
    ...
    \item \textbf{Flusso principale}:
    \begin{enumerate}
        \item L'Utente visualizza un messaggio di notifica che indica che la Ricerca Semantica è disponibile.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            ...
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{addValoreOggetto} - Specifica valore Oggetto, \ref{addValoreParoleChiave} - Specifica valore Parole Chiave
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Classificazione (\ref{compilaValoreFiltroStringa}) tra:
                        \begin{itemize}
                  ...
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroStringa} Compilazione Valore Filtro: stringa
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            ...
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroTempoDiConservazione} Compilazione Valore Filtro: tempo di conservazione
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente specifica il tipo di aggregazione (\ref{compilaValoreFiltroTipoAggregazione}) tra:
            \begin{itemize}
                  \item Fascicolo,
            ...
            \item Il sistema imposta questo valore come parametro per la ricerca.
      \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroTipoAggregazione} Compila valore filtro: tipo aggregazione
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica l'Id dell'Aggregazione. (\ref{compilaValoreFiltroStringa})
                  \item Il sistema imposta questo valore come parametro per la ricerca.
            \end{enumerate}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica il tipo di fascicolo (\ref{compilaValoreFiltroTipoFascicolo}) tra: \begin{itemize}
                              \item Affare,
                              \item Attività,
                              \item Persona Fisica,
                  ...
                  \item Il sistema imposta questo valore come parametro per la ricerca.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroTipoFascicolo} Compila valore filtro: tipo fascicolo
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica l'Id Primario dell'Aggregazione. (\ref{compilaValoreFiltroStringa})
                  \item Il sistema imposta questo valore come parametro per la ricerca.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroStringa} Compila valore filtro: stringa
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica la Data di Apertura. (\ref{compilaValoreFiltroData})
                  \item Il sistema imposta questo valore come parametro per la ricerca.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroData} Compila valore filtro: data
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica la Data di Chiusura. (\ref{compilaValoreFiltroData})
                  \item Il sistema imposta questo valore come parametro per la ricerca.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroData} Compila valore filtro: data
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente specifica la Materia, Argomento e Struttura per i procedimenti. (\ref{compilaValoreFiltroStringa})
            \item L'Utente specifica il Procedimento come denominazione. (\ref{compilaValoreFiltroStringa})
            \item L'Utente specifica il Catalogo dei Procedimenti come URI di pubblicazione del catalogo. (\ref{compilaValoreFiltroStringa})
      ...
      \begin{itemize}
            ...
            \item \ref{compilaValoreFiltroStringa} Compila valore filtro: stringa
      \end{itemize}
\end{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \begin{itemize}
                  ...
                  Integrazione dell'efficacia). (\ref{compilaValoreFiltroTipoFase})
                  \item Data di inizio. (\ref{compilaValoreFiltroData})
                  \item Data di fine. (\ref{compilaValoreFiltroData})
            \end{itemize}
            \item Il sistema salva la fase come parte del filtro Procedimento Amministrativo.
      \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroTipoFase} Compila valore filtro tipo fase, \ref{compilaValoreFiltroData} Compila valore filtro data
\end{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \begin{itemize}
                  \item Tipo Assegnazione. (\ref{compilaValoreFiltroAssegnazione})
                  \item Soggetto Assegnatario (Codice Fiscale). (\ref{compilaValoreFiltroStringa})
                  \item Data di Inizio. (\ref{compilaValoreFiltroData})
                  \item Data di Fine. (\ref{compilaValoreFiltroData})
            \end{itemize}
            \item Il sistema salva il valore di assegnazione come parte del filtro Assegnazione.
      \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroAssegnazione} Compila valore filtro tipo assegnazione, \ref{compilaValoreFiltroStringa} Compila valore filtro stringa, \ref{compilaValoreFiltroData} Compila valore filtro data
\end{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema imposta questo valore come parametro per la ricerca.
      \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroNumero} Compila valore filtro numero
\end{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              \item Denominazione Amministrazione/ Codice \glossario{IPA} (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione \glossario{AOO}/ Codice IPA AOO (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione \glossario{UOR}/ Codice IPA UOR (\ref{compilaValoreFiltroStringa})
                              \item Indirizzi Digitali di Riferimento (\ref{compilaValoreFiltroStringa})
                        \end{itemize}
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroStringa} Compila valore filtro stringa
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              \item Denominazione Amministrazione (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Ufficio (\ref{compilaValoreFiltroStringa})
                              \item \glossario{Indirizzi Digitali} di Riferimento (\ref{compilaValoreFiltroStringa})
                        \end{itemize}
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroStringa} Compila valore filtro stringa
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              \item Cognome (\ref{compilaValoreFiltroStringa})
                              \item Nome (\ref{compilaValoreFiltroStringa})
                              \item Codice Fiscale (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione/ Codice IPA (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione AOO/ Codice IPA AOO (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione UOR/ Codice IPA UOR (\ref{compilaValoreFiltroStringa})
                              \item Indirizzi Digitali di Riferimento (\ref{compilaValoreFiltroStringa})
                        \end{itemize}
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            </end{enumerate}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              \item Denominazione Organizzazione (\ref{compilaValoreFiltroStringa})
                              \item Codice fiscale / Partita Iva (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Ufficio (\ref{compilaValoreFiltroStringa})
                              \item Indirizzi Digitali di Riferimento (\ref{compilaValoreFiltroStringa})
                        \end{itemize}
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            ...
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              ...
                              \item Codice Fiscale (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione/ Codice IPA (\ref{compilaValoreFiltroStringa})
                              \item Denominazione Amministrazione AOO/Denominazione Amministrazione UOR (\ref{compilaValoreFiltroStringa})
                              \item  Denominazione Amministrazione UOR/ Codice IPA UOR (\ref{compilaValoreFiltroStringa})
                              \item Indirizzi Digitali di Riferimento (\ref{compilaValoreFiltroStringa})
                        \end{itemize}
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce la Denominazione Sistema. (\ref{compilaValoreFiltroStringa})
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltroStringa} Compila valore filtro: stringa
      \item \textbf{Specializza}: \ref{addDettagliSoggetto} Specifica dettagli soggetto
...
\usecase{compilaValoreFiltroStringa}{Compila Valore Filtro: stringa}
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../../assets/uml/UC17.png}
      \caption{\ref{compilaValoreFiltroStringa} - Compila valore filtro: stringa}
      \label{fig:uc_compilaValoreFiltroStringa}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente sta specificando il valore per un metadato di tipo alfanumerico di un filtro selezionato.
      \end{itemize}
      \item \textbf{Postcondizioni}: Il valore inserito dall'Utente viene salvato come parte del filtro selezionato.
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente inserisce il valore alfanumerico per il metadato di cui vuole specificare il valore.
            \item Il sistema salva il valore inserito come parte del filtro selezionato.
      \end{enumerate}
      \item \textbf{Flusso Alternativo}:
      \begin{itemize}
            \item Il valore non rispetta il formato corretto (\ref{formatoNonCorrettoStringa}).
      \end{itemize}
