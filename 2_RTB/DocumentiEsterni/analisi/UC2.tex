            ...
            \begin{enumerate}
                  \item L'Utente compila i valori di Classificazione (\ref{compilaValoreFiltro}) tra:
                        \begin{itemize}
                              ...
                              \item Descrizione
                              \item \glossario{Piano di Classificazione}
                        \end{itemize}
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltro} Compilazione Valore Filtro
...
\deepusecase{CompilaIndiceClassificazione}{Compila filtro indice di classificazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:  \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente ha selezionato il filtro Classificazione tra i campi comuni
            \item L'Utente ha selezionato di compilare l'Indice di Classificazione come valore del filtro Classificazione
      \end{itemize}
      \item \textbf{Postcondizioni}: \begin{itemize}
            \item L'Utente ha specificato i valori del filtro Classificazione con l'Indice di Classificazione
            \item Il filtro Classificazione con l'Indice di Classificazione è parametro per la ricerca con filtri e per la generazione del risultato
            \item Il sistema riceve i valori dell'Indice di Classificazione come parametri di ricerca
            \item Il sistema produce i risultati di ricerca in base ai valori dell'Indice di Classificazione specificati                                   
      \end{itemize}
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Classificazione (\ref{compilaValoreFiltro}) con l'Indice di Classificazione
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Specifica}: \ref{addClassificazione} Specifica filtro Classificazione
\end{itemize}

\deepusecase{CompilaDescrizione}{Compila filtro descrizione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:  \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente ha selezionato il filtro Classificazione tra i campi comuni
            \item L'Utente ha selezionato di compilare Descrizione come valore del filtro Classificazione
      \end{itemize}
      \item \textbf{Postcondizioni}: \begin{itemize}
            \item L'Utente ha specificato i valori del filtro Classificazione con Descrizione
            \item Il filtro Classificazione  Descrizione è parametro per la ricerca con filtri e per la generazione del risultato
            \item Il sistema riceve i valori Descrizione come parametri di ricerca
            \item Il sistema produce i risultati di ricerca in base ai valori di Descrizione specificati                                   
      \end{itemize}
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Classificazione (\ref{compilaValoreFiltro}) con Descrizione
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Specifica}: \ref{addClassificazione} Specifica filtro Classificazione
\end{itemize}

\deepusecase{CompilaPianoClassificazione}{Compila Piano di classificazione}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:  \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente ha selezionato il filtro Classificazione tra i campi comuni
            \item L'Utente ha selezionato di compilare Piano di Classificazione come valore del filtro Classificazione
      \end{itemize}
      \item \textbf{Postcondizioni}: \begin{itemize}
            \item L'Utente ha specificato i valori del filtro Classificazione con Piano di Classificazione
            \item Il filtro Classificazione con Piano di Classificazione è parametro per la ricerca con filtri e per la generazione del risultato
            \item Il sistema riceve i valori Piano di Classificazione come parametri di ricerca
            \item Il sistema produce i risultati di ricerca in base ai valori Piano di Classificazione specificati                                   
      \end{itemize}
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Classificazione (\ref{compilaValoreFiltro}) con Piano di Classificazione
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Specifica}: \ref{addClassificazione} Specifica filtro Classificazione
\end{itemize}
...
\deepusecase{CompilaDocumentoInformatico}{Compila documento informatico}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:  \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente ha selezionato il filtro Tipo documento tra i campi comuni
            \item L'Utente ha selezionato di compilare Documento informatico come valore del filtro Tipo documento
      \end{itemize}
      \item \textbf{Postcondizioni}: \begin{itemize}
            \item L'Utente ha specificato i valori del filtro Tipo Documento con i campi specifici per il Documento Informatico
            \item Il filtro Documento informatico con Documento informatico è parametro per la ricerca con filtri e per la generazione del risultato
            \item Il sistema riceve i valori Documento informatico come parametri di ricerca
            \item Il sistema produce i risultati di ricerca in base ai valori di Documento informatico specificati                                   
      \end{itemize}
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Tipo Documento (\ref{compilaValoreFiltro}) con Documento informatico
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Specifica}: \ref{addTipoDocumento} Specifica filtro Tipo documento
\end{itemize}

\deepusecase{CompilaDocumentoAmministrativoInformatico}{Compila documento amministrativo informatico}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:  \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente ha selezionato il filtro Tipo documento tra i campi comuni
            \item L'Utente ha selezionato di compilare Documento amministrativo informatico come valore del filtro Tipo documento
      \end{itemize}
      \item \textbf{Postcondizioni}: \begin{itemize}
            \item L'Utente ha specificato i valori del filtro Tipo Documento con i campi specifici per il Documento Amministrativo Informatico
            \item Il filtro Documento amministrativo informatico con Documento amministrativo informatico è parametro per la ricerca con filtri e per la generazione del risultato
            \item Il sistema riceve i valori Documento amministrativo informatico come parametri di ricerca
            \item Il sistema produce i risultati di ricerca in base ai valori di Documento amministrativo informatico specificati                                   
      \end{itemize}
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Tipo Documento (\ref{compilaValoreFiltro}) con Documento amministrativo informatico
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Specifica}: \ref{addTipoDocumento} Specifica filtro Tipo documento
\end{itemize}

\deepusecase{CompilaAggregazioneDocumentale}{Compila aggregazione documentale}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}:  \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente ha selezionato il filtro Tipo documento tra i campi comuni
            \item L'Utente ha selezionato di compilare Aggregazione documentale come valore del filtro Tipo documento
      \end{itemize}
      \item \textbf{Postcondizioni}: \begin{itemize}
            \item L'Utente ha specificato i valori del filtro Tipo Documento con i campi specifici per l'Aggregazione Documentale
            \item Il filtro Aggregazione documentale con Aggregazione documentale è parametro per la ricerca con filtri e per la generazione del risultato
            \item Il sistema riceve i valori Aggregazione documentale come parametri di ricerca
            \item Il sistema produce i risultati di ricerca in base ai valori di Aggregazione documentale specificati                                   
      \end{itemize}
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente compila i valori di Tipo Documento (\ref{compilaValoreFiltro}) con Aggregazione documentale
                  \item Il sistema imposta i valori del filtro come parametri di ricerca.
            \end{enumerate}
      \item \textbf{Specifica}: \ref{addTipoDocumento} Specifica filtro Tipo documento
\end{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item L'Utente specifica il Numero Documento (di Registrazione del Documento o di Protocollo) (\ref{compilaValoreFiltro})
            \item L'Utente specifica il Codice Registro (\ref{compilaValoreFiltro})
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{../../assets/uml/UC13INC.png}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              \item Denominazione Amministrazione/ Codice \glossario{IPA} (\ref{compilaValoreFiltro})
                              \item Denominazione Amministrazione \glossario{AOO}/ Codice IPA AOO (\ref{compilaValoreFiltro})
                              \item Denominazione Amministrazione \glossario{UOR}/ Codice IPA UOR (\ref{compilaValoreFiltro})
            ...
            \begin{enumerate}
                  \item L'Utente inserisce i valori per i campi:
                        \begin{itemize}
                              ...
                              \item \glossario{Indirizzi Digitali} di Riferimento (\ref{compilaValoreFiltro})
                        \end{itemize}
                  \item Il sistema salva i dettagli inseriti per il soggetto che l'utente sta aggiungendo.
            \end{enumerate}
      \item \textbf{Inclusioni}: \ref{compilaValoreFiltro} Compila valore filtro
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../../assets/uml/UC17.png}
      \caption{\ref{compilaValoreFiltro} - Compila valore filtro}
...
\begin{itemize}
      ...
      \begin{itemize}
            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente sta specificando il valore per un metadato di un filtro selezionato.
      \end{itemize}
