...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC11.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC12.1.2INC.png}
    \caption{Inclusioni \ref{addChiaveDescrittiva} - Specifica filtro Chiave Descrittiva}
    \label{fig:addChiaveDescrittiva}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC12.1.3INC.png}
    \caption{Inclusioni \ref{addClassificazione} - Specifica filtro Classificazione}
    \label{fig:addClassificazione}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC12.1.4.png}
    \caption{\ref{addTempoConserva} - Specifica filtro Tempo di Conservazione}
    \label{fig:addTempoConserva}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema riceve l'indicazione che il tempo di conservazione è perenne e salva il valore '9999' per il filtro Tempo di Conservazione.
      \end{enumerate}
      \item \textbf{Specializza}: \ref{addTempoConserva} Specifica filtro Tempo di Conservazione
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC12.1.5.png}
    \caption{\ref{addNote} - Specifica filtro Note}
    \label{fig:addNote}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC12.1.6.png}
    \caption{\ref{addTipoDocumento} - Specifica filtro Tipo documento}
    \label{fig:addTipoDocumento}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: \begin{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema riceve il valore "Creazione di un documento informatico ex novo" per il filtro Modalità di Formazione e lo imposta come parametro per la ricerca. Riferimento alla normativa: \textit{"creazione tramite l'utilizzo di strumenti software che assicurino la produzione di documenti nei formati previsti nell'Allegato 2 delle Linee Guida"}
      \end{enumerate}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema riceve il valore "Acquisizione di un documento informatico da altro documento informatico o da supporto informatico" per il filtro Modalità di Formazione e lo imposta come parametro per la ricerca. Riferimento alla normativa: \textit{"acquisizione di un documento informatico per via telematica o su supporto informatico, acquisizione della copia per immagine su supporto informatico di un documento analogico, acquisizione della copia informatica di un documento analogico"}
      \end{enumerate}
      \item \textbf{Specializza}: \ref{addModalitaFormazione}
\end{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema riceve il valore "Memorizzazione su supporto informatico in formato digitale" per il filtro Modalità di Formazione e lo imposta come parametro per la ricerca. Riferimento alla normativa: \textit{"memorizzazione su supporto informatico in formato digitale delle informazioni risultanti da transazioni o processi informatici o dalla presentazione telematica di dati attraverso moduli o formulari resi disponibili all'utente"}
      \end{enumerate}
      \item \textbf{Specializza}: \ref{addModalitaFormazione}
\end{itemize}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema riceve il valore "Generazione o raggruppamento in forma statica" per il filtro Modalità di Formazione e lo imposta come parametro per la ricerca. Riferimento alla normativa: \textit{"generazione o raggruppamento anche in via automatica di un insieme di dati o registrazioni, provenienti da una o più banche dati, anche appartenenti a più soggetti interoperanti, secondo una struttura logica predeterminata e memorizzata in forma statica"}
      \end{enumerate}
      \item \textbf{Specializza}: \ref{addModalitaFormazione}
\end{itemize}
...
\begin{figure}[H]
      ...
      \caption{Inclusioni \ref{addNomeDocumento} - Specifica filtro Nome del Documento}
      \label{fig:inclusioniSpecificaFiltroNomeDocumento}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  ...
                  \item L'Utente specifica la Data/Ora della Modifica. (\ref{addValoreDataOraModifica})
...
\subsubdeepusecase{addValoreTipoModificaRettifica}{Specifica valore tipo di modifica: "Rettifica"}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}            
            ...
            \item L'utente ha selezionato il filtro Tracciature Modifiche di Documento tra i campi specifici per tipo documentale
      \end{itemize}
      \item \textbf{Postcondizioni}: Viene selezionato "Rettifica" come valore del tipo di modifica e salvato per il filtro Tracciature Modifiche di Documento.
      \item \textbf{Flusso Principale}:
            \begin{enumerate}
                  \item L'Utente specifica il valore del tipo di modifica: "Rettifica".
                  \item Il sistema salva il valore del tipo di modifica per il filtro Tracciature Modifiche di Documento.
            \end{enumerate}
      \item \textbf{Specializza}: \ref{addValoreTipoModifica}
\end{itemize}
...
\subdeepusecase{addValoreDataOraModifica}{Specifica Data/Ora della Modifica per filtro Tracciature Modifiche di Documento}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}            
...
\subdeepusecase{addValoreIdVersionePrecedente}{Specifica identificativo documento versione precedente per filtro Tracciature Modifiche di Documento}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}            
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC12.2.2.8.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1.1\textwidth]{../../assets/uml/UC12.2.2.8.4INC.png}
      \caption{Inclusioni \ref{addProcedimentoAmministrativo} - Specifica filtro Procedimento Amministrativo}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=1.1\textwidth]{../../assets/uml/UC12.2.2.9INC.png}
...
\begin{itemize}
      ...
      \begin{enumerate}
            ...
            \item Il sistema salva il valore del Tipo Assegnazione per l'assegnazione che si sta specificando.
      \end{enumerate}
      \item \textbf{Specializza}: \ref{addValoreTipoAssegnazione} Compila valore filtro tipo assegnazione
\end{itemize}
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente specifica il nome del metadato custom.
            \item L'Utente specifica il valore del metadato custom per cui ricercare.
...
\deepusecase{addValoreNomeMetadatoCustom}{Specifica valore Nome del Metadato Custom per filtro del Metadato Custom}
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../../assets/uml/UC12.3.1.1.png}
      \caption{\ref{addValoreNomeMetadatoCustom} - Specifica valore Nome del Metadato Custom per filtro del Metadato Custom}
      \label{fig:addValoreNomeMetadatoCustom}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}            \item L'Utente ha avviato l'applicazione
            \item L'Utente sta effettuando una ricerca nel DIP con filtri
            \item L'Utente sta specificando un filtro per un metadato custom
      \end{itemize}
      \item \textbf{Postcondizioni}: Viene specificato il nome del metadato custom per il filtro del metadato custom che si sta specificando.
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente specifica il nome del metadato custom per il filtro del metadato custom.
            \item Il sistema salva il nome del metadato custom per il filtro del metadato custom che si sta specificando.
      \end{enumerate}
      \item \textbf{Flusso Alternativo}:
      \begin{itemize}            \item L'Utente inserisce un valore non valido per il nome del metadato custom (stringa vuota) (\ref{formatoNonCorrettoStringa})
      \end{itemize}
      \item \textbf{Estensioni}: \ref{formatoNonCorrettoStringa} Formato non corretto: stringa
\end{itemize}

\deepusecase{addValoreValoreMetadatoCustom}{Specifica valore del Metadato Custom per filtro del Metadato Custom}
\begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{../../assets/uml/UC12.3.1.2.png}
      \caption{\ref{addValoreValoreMetadatoCustom} - Specifica valore del Metadato Custom per filtro del Metadato Custom}
      \label{fig:addValoreValoreMetadatoCustom}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
      \begin{itemize}            \item L'Utente ha avviato l'applicazione
            ...
            \item L'Utente sta specificando un filtro per un metadato custom
      \end{itemize}
      \item \textbf{Postcondizioni}: Viene specificato il valore del metadato custom per il filtro del metadato custom che si sta specificando.
      \item \textbf{Flusso Principale}:
      \begin{enumerate}
            \item L'Utente specifica il valore del metadato custom per il filtro del metadato custom.
            \item Il sistema salva il valore del metadato custom per il filtro del metadato custom che si sta specificando.
      \end{enumerate}
      \item \textbf{Flusso Alternativo}:
      \begin{itemize}            \item L'Utente inserisce un valore non valido per il valore del metadato custom (stringa vuota) (\ref{formatoNonCorrettoStringa})
      \end{itemize}
      \item \textbf{Estensioni}: \ref{formatoNonCorrettoStringa} Formato non corretto: stringa
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../../assets/uml/UC13.3.1INC.png}
    \caption{Inclusioni \ref{addDettagliPAI} - Specifica dettagli soggetto tipo: PAI}
    \label{fig:addDettagliPAI}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.1.1.png}
    \caption{\ref{addValoreDenominazioneAmmIPA} - Specifica valore Denominazione Amministrazione/ Codice IPA}
    \label{fig:addValoreDenominazioneAmmIPA}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.1.2.png}
    \caption{\ref{addValoreDenominazioneAmmAOO} - Specifica valore Denominazione Amministrazione AOO/ Codice IPA AOO}
    \label{fig:addValoreDenominazioneAmmAOO}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.1.3.png}
    \caption{\ref{addValoreDenominazioneAmmUOR} - Specifica valore Denominazione Amministrazione UOR/ Codice IPA UOR}
    \label{fig:addValoreDenominazioneAmmUOR}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.1.4.png}
    \caption{\ref{addValoreIndirizziDigitali} - Specifica valore Indirizzi Digitali di Riferimento}
    \label{fig:addValoreIndirizziDigitali}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../../assets/uml/UC13.3.2INC.png}
    \caption{Inclusioni \ref{addDettagliPAE} - Specifica dettagli soggetto tipo: PAE}
    \label{fig:addDettagliPAE}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.2.1.png}
    \caption{\ref{addValoreDenominazioneAmministrazione} - Specifica valore Denominazione Amministrazione}
    \label{fig:addValoreDenominazioneAmministrazione}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.2.2.png}
    \caption{\ref{addValoreDenominazioneUfficio} - Specifica valore Denominazione Ufficio}
    \label{fig:addValoreDenominazioneUfficio}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.3INC.png}
    \caption{Inclusioni \ref{addDettagliAS} - Specifica dettagli soggetto tipo: AS}
    \label{fig:addDettagliAS}
\end{figure}

\deepusecase{addValoreCognome}{Specifica valore Cognome} \label{addValoreCognome}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.3.1.png}
    \caption{\ref{addValoreCognome} - Specifica valore Cognome}
    \label{fig:addValoreCognome}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.3.2.png}
    \caption{\ref{addValoreNome} - Specifica valore Nome}
    \label{fig:addValoreNome}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.3.3.png}
    \caption{\ref{addValoreCF} - Specifica valore Codice Fiscale / Partita Iva}
    \label{fig:addValoreCF}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{itemize}
      ...
      \item \textbf{Flusso Principale}:
            ...
            \end{enumerate}
      \item \textbf{Inclusioni}: \begin{itemize}
            \item \ref{addValoreDenominazioneOrganizzazione} Specifica valore Denominazione Organizzazione
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../../assets/uml/UC13.3.4INC.png}
    \caption{Inclusioni \ref{addDettagliPG} - Specifica dettagli soggetto tipo: PG}
    \label{fig:addDettagliPG}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.4.1.png}
    \caption{\ref{addValoreDenominazioneOrganizzazione} - Specifica valore Denominazione Organizzazione}
    \label{fig:addValoreDenominazioneOrganizzazione}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../../assets/uml/UC13.3.5INC.png}
    \caption{Inclusioni \ref{addDettagliPF} - Specifica dettagli soggetto tipo: PF}
    \label{fig:addDettagliPF}
\end{figure}
...
\begin{itemize}
      ...
      \item \textbf{Inclusioni}: \begin{itemize}
            ...
            \item \ref{addValoreCF} Specifica valore Codice Fiscale / Partita Iva
            \item \ref{addValoreDenominazioneAmmIPA} Specifica valore Denominazione Amministrazione/ Codice IPA
            \item \ref{addValoreDenominazioneAmmAOO} Specifica valore Denominazione Amministrazione AOO/Denominazione Amministrazione UOR
            \item \ref{addValoreIndirizziDigitali} Specifica valore Indirizzi Digitali di Riferimento
      \end{itemize}
      \item \textbf{Specializza}: \ref{addDettagliSoggetto} Specifica dettagli soggetto
\end{itemize}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.6INC.png}
    \caption{Inclusioni \ref{addDettagliRUP} - Specifica dettagli soggetto tipo: RUP}
    \label{fig:addDettagliRUP}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../../assets/uml/UC13.3.7INC.png}
    \caption{Inclusioni \ref{addDettagliSW} - Specifica dettagli soggetto tipo: SW}
    \label{fig:addDettagliSW}
\end{figure}

\deepusecase{addValoreDenominazioneSistema}{Specifica valore Denominazione Sistema} \label{addValoreDenominazioneSistema}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../../assets/uml/UC13.3.7.1.png}
    \caption{\ref{addValoreDenominazioneSistema} - Specifica valore Denominazione Sistema}
    \label{fig:addValoreDenominazioneSistema}
\end{figure}
\begin{itemize}
      \item \textbf{Attore Primario}: Utente
      \item \textbf{Precondizioni}: 
