...
Per una corretta comprensione del documento, si rimanda al documento di \href{https://7-zpus.github.io/Docs/assets/pdf/Glossario.pdf}{\ul{Glossario}\setulcolor{black}} contenente la definizione dei termini contrassegnati dalla \textit{G} a pedice (\glossario{Glossario}).
...
\begin{itemize}
    ...
    \item \href{https://7-zpus.github.io/Docs/assets/pdf/NormeDiProgetto.pdf}{\ul{Norme di Progetto}\setulcolor{black}} \ped{(ultimo accesso: 11/02/2026)}
\end{itemize}

\subsubsection{Riferimenti Informativi}
\begin{itemize}
    \item \href{https://7-zpus.github.io/Docs/assets/pdf/Glossario.pdf}{\ul{Glossario di progetto}\setulcolor{black}} \ped{(ultimo accesso: 11/02/2026)}
