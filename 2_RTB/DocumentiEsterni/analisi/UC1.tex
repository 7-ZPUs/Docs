...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni}: L'Utente visualizza l'elenco delle \glossario{classi documentali}.
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Postcondizioni}: L'Utente visualizza un elemento della lista delle classi documentali.
    \item \textbf{Flusso Principale}:
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: \begin{itemize}
        \item L'Utente ha avviato l'applicazione.
        \item L'Utente sta visualizzando una classe documentale in elenco o i dettagli di una classe documentale.
    \end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Postcondizioni}: L'Utente visualizza la lista dei processi associati alla classe selezionata.
    \item \textbf{Flusso Principale}: 
          \begin{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'Utente ha selezionato una delle Classi Documentali del DIP
    \end{itemize}
    \item \textbf{Postcondizioni}: L'Utente visualizza un elemento della lista dei processi della classe documentale selezionata.
    \item \textbf{Flusso Principale}:
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: \begin{itemize}
        \item L'utente ha avviato l'applicazione
        \item L'utente sta visualizzando un processo in elenco o i dettagli di un processo
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Flusso Principale}:
    \begin{enumerate}
        \item Il sistema mostra a video l'elenco dei documenti del processo selezionato.
    \end{enumerate}
    \item \textbf{Flusso Alternativo}:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'Utente ha selezionato un processo associato alla classe documentale selezionata
    \end{itemize}
    \item \textbf{Postcondizioni}: L'Utente visualizza un elemento della lista dei documenti del processo selezionato.
    \item \textbf{Flusso Principale}:
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: \begin{itemize}
        \item L'utente ha avviato l'applicazione
        \item L'Utente sta visualizzando un documento in elenco o i dettagli di un documento
    \end{itemize}
...
\subusecase{statoVerificaElementoNonIntegro}{Visualizza stato di verifica elemento "Non integro"}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}: \begin{itemize}
        \item L'Utente ha avviato l'applicazione
        \item L'Utente ha selezionato un elemento.
    \end{itemize}
    \item \textbf{Postcondizioni}: L'utente visualizza lo stato di verifica "Non integro" dell' elemento selezionato.
    \item \textbf{Flusso Principale}:
    \begin{enumerate}
              \item Il sistema mostra a video lo stato di verifica "Non integro" dell'elemento selezionato
    \end{enumerate}
...
\subusecase{statoVerificaElementoIntegro}{Visualizza stato di verifica elemento "Integro"}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}: \begin{itemize}
        \item L'Utente ha avviato l'applicazione
        \item L'Utente ha selezionato un elemento.
    \end{itemize}
    \item \textbf{Postcondizioni}: L'utente visualizza lo stato di verifica "Integro" dell' elemento selezionato.
    \item \textbf{Flusso Principale}:
    \begin{enumerate}
              \item Il sistema mostra a video lo stato di verifica "Integro" dell'elemento selezionato
    \end{enumerate}
    \item \textbf{Specializza}:
    \begin{enumerate}
              \item \ref{statoVerificaElemento} Visualizza stato di verifica elemento
...
\subusecase{statoVerificaElementoNonVerificato}{Visualizza stato di verifica elemento "Non verificato"}
\begin{itemize}
    \item \textbf{Attore Primario}: Utente
    \item \textbf{Precondizioni}: \begin{itemize}
        \item L'Utente ha avviato l'applicazione
        \item L'Utente ha selezionato un elemento.
    \end{itemize}
    \item \textbf{Postcondizioni}: L'utente visualizza lo stato di verifica "Non verificato" dell' elemento selezionato.
    \item \textbf{Flusso Principale}:
    \begin{enumerate}
              \item Il sistema mostra a video lo stato di verifica "Non verificato" dell'elemento selezionato
    \end{enumerate}
    \item \textbf{Specializza}:
    \begin{enumerate}
              \item \ref{statoVerificaElemento} Visualizza stato di verifica elemento
...
\begin{itemize}
    ...
    \begin{itemize}
        \item L'utente ha avviato l'applicazione
        \item L'Utente ha selezionato un \glossario{documento}.
    \end{itemize}
