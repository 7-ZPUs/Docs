...
\begin{tabular}{|c|c|c|c|}
    ...
    \hline 
    1.4               & 27/10/2025   & Georgescu Diana   & Aggiunta del Capitolato C9\\
    \hline
...
\subsubsection*{Azienda Proponente:} Var Group
\subsubsection*{Committente:} Prof. Tullio Verdanega e Prof. Riccardo Cardin.
\subsubsection*{Obiettivo:} Il progetto mira a sviluppare una piattaforma web basata su un sistema multi-agente per l’audit e la remediation automatica dei repository software, in particolare quelli ospitati su GitHub. Vengono analizzati fattori come:
\begin{itemize}
    \item Test coverage
...
\begin{itemize}
    ...
    \item Richiesta di completamento di tutti i moduli per vincolo di accettazione.
\end{itemize}
...
\subsubsection*{Dominio Tecnico}
\begin{itemize}
    \item Front-end: Applicativo web responsive, librerie JS/CSS, design wireframe tramite Figma/Draw.io.
    \item Back-end: Node.js con Express, Java con Spring, Python con Flask o FastAPI. SDK per interfaccia KNX IoT 3rd-party API.
    \item Infrastruttura Cloud: Container Docker, Infrastructure as Code, servizi opzionali AWS.
    \item Database: Relazionali per applicativo web, NoSQL per analytics.
    \item Autenticazione e API: KNX IoT 3rd-party API, OAuth2, push notification tramite subscription KNX IoT.
    \item Versionamento: Git, repository pubblico, licenza open source.
\end{itemize}
...
\subsubsection*{Aspetti Negativi / Limitazioni}
\begin{itemize}
